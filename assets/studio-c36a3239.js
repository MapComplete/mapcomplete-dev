...
iftrue: Do not write 'change_within_x_m' and do not indicate that this was done by survey`,type:"boolean"}},Ha=["id","pointRendering","source"],Ua={TagConfigJson:{description:`The main representation of Tags.
See https://github.com/pietervdvn/MapComplete/blob/develop/Docs/Tags_format.md for more documentation
...
When a default input method should be used, this can be specified by setting the canonical denomination here, e.g.
\`defaultInput: "cm"\`. This must be a denomination which appears in the applicableUnits`,type:"string"}},required:["applicableUnits"],additionalProperties:!1},"Record<string,string|{quantity:string;denominations:string[];canonical?:string|undefined;inverted?:boolean|undefined;}>":{type:"object",additionalProperties:!1}},Ba="http://json-schema.org/draft-07/schema#",za=!1,Va={description:La,type:Ea,properties:Pa,required:Ha,definitions:Ua,$schema:Ba,additionalProperties:za},Qa=`Defines the entire theme.
