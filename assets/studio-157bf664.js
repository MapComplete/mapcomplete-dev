...
no-question-hint-check: disables a check in MiscTagRenderingChecks which complains about 'div', 'span' or 'class=subtle'-HTML elements in the tagRendering`},{path:["fullNodeDatabase"],required:!1,hints:{group:"hidden"},type:"boolean",description:"_Set automatically by MapComplete, please ignore_"}];class ko{static isTranslation(e){return e.type?Array.isArray(e.type)?e.type.some(t=>t.$ref==="#/definitions/Record<string,string>"):e.type.$ref==="#/definitions/Record<string,string>":!1}}function xo(o){let e,t,n,i=o[0].message+"",a,s,l,r;return t=new Zi({props:{class:"mx-1 h-6 w-6 shrink-0"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),a=O(i),s=A(),l=v("div"),_(e,"class","information flex items-center justify-between")},m(h,d){b(h,e,d),$(t,e,null),g(e,n),g(e,a),g(e,s),g(e,l),r=!0},p(h,d){(!r||d&1)&&i!==(i=h[0].message+"")&&X(a,i)},i(h){r||(u(t.$$.fragment,h),r=!0)},o(h){m(t.$$.fragment,h),r=!1},d(h){h&&y(e),C(t)}}}function $o(o){let e,t,n,i=o[0].message+"",a,s,l,r;return t=new ft({props:{class:"mx-1 h-6 w-6 shrink-0"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),a=O(i),s=A(),l=v("div"),_(e,"class","warning flex items-center justify-between")},m(h,d){b(h,e,d),$(t,e,null),g(e,n),g(e,a),g(e,s),g(e,l),r=!0},p(h,d){(!r||d&1)&&i!==(i=h[0].message+"")&&X(a,i)},i(h){r||(u(t.$$.fragment,h),r=!0)},o(h){m(t.$$.fragment,h),r=!1},d(h){h&&y(e),C(t)}}}function Co(o){let e,t,n,i=o[0].message+"",a,s,l,r;return t=new ft({props:{class:"mx-1 h-6 w-6 shrink-0"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),a=O(i),s=A(),l=v("div"),_(e,"class","alert flex items-center justify-between")},m(h,d){b(h,e,d),$(t,e,null),g(e,n),g(e,a),g(e,s),g(e,l),r=!0},p(h,d){(!r||d&1)&&i!==(i=h[0].message+"")&&X(a,i)},i(h){r||(u(t.$$.fragment,h),r=!0)},o(h){m(t.$$.fragment,h),r=!1},d(h){h&&y(e),C(t)}}}function Ao(o){let e,t,n,i;const a=[Co,$o,xo],s=[];function l(r,h){return r[0].level==="error"?0:r[0].level==="warning"?1:r[0].level==="information"?2:-1}return~(e=l(o))&&(t=s[e]=a[e](o)),{c(){t&&t.c(),n=ie()},m(r,h){~e&&s[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?~e&&s[e].p(r,h):(t&&(G(),m(s[d],1,1,()=>{s[d]=null}),Y()),~e?(t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n)):t=null)},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){~e&&s[e].d(r),r&&y(n)}}}function Ro(o,e,t){let{message:n}=e;return o.$$set=i=>{"message"in i&&t(0,n=i.message)},[n]}class ot extends ae{constructor(e){super(),re(this,e,Ro,Ao,le,{message:0})}}function wt(o,e,t){const n=o.slice();return n[19]=e[t],n}function So(o){let e,t,n,i,a;t=new Be({props:{editMode:o[7],config:o[3],selectedElement:void 0,state:o[0],tags:o[8]}});let s=o[5].length>0&&vt(o),l=window.location.hostname==="127.0.0.1"&&jo(o);return{c(){e=v("div"),x(t.$$.fragment),n=A(),s&&s.c(),i=A(),l&&l.c(),_(e,"class","flex w-full flex-col")},m(r,h){b(r,e,h),$(t,e,null),g(e,n),s&&s.m(e,null),g(e,i),l&&l.m(e,null),a=!0},p(r,h){const d={};h&8&&(d.config=r[3]),h&1&&(d.state=r[0]),t.$set(d),r[5].length>0?s?(s.p(r,h),h&32&&u(s,1)):(s=vt(r),s.c(),u(s,1),s.m(e,i)):s&&(G(),m(s,1,1,()=>{s=null}),Y()),window.location.hostname==="127.0.0.1"&&l.p(r,h)},i(r){a||(u(t.$$.fragment,r),u(s),a=!0)},o(r){m(t.$$.fragment,r),m(s),a=!1},d(r){r&&y(e),C(t),s&&s.d(),l&&l.d()}}}function Io(o){let e,t;return{c(){e=v("span"),t=O(o[4]),_(e,"class","alert")},m(n,i){b(n,e,i),g(e,t)},p(n,i){i&16&&X(t,n[4])},i:z,o:z,d(n){n&&y(e)}}}function vt(o){let e,t,n=o[5],i=[];for(let s=0;s<n.length;s+=1)i[s]=_t(wt(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l&32){n=s[5];let r;for(r=0;r<n.length;r+=1){const h=wt(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=_t(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function _t(o){let e,t;return e=new ot({props:{message:o[19]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&32&&(a.message=n[19]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function jo(o){let e,t,n,i=o[1].join(".")+"",a,s,l,r=o[2].hints.typehint+"",h,d,p=o[2].hints.group+"",c,f,w;return{c(){e=v("span"),t=O("SchemaBasedField "),n=v("b"),a=O(i),s=A(),l=v("span"),h=O(r),d=O(`
        Group: `),c=O(p),_(l,"class","cursor-pointer"),_(e,"class","subtle")},m(k,T){b(k,e,T),g(e,t),g(e,n),g(n,a),g(e,s),g(e,l),g(l,h),g(e,d),g(e,c),f||(w=[Z(l,"click",o[10]),Z(e,"click",o[11])],f=!0)},p(k,T){T&2&&i!==(i=k[1].join(".")+"")&&X(a,i),T&4&&r!==(r=k[2].hints.typehint+"")&&X(h,r),T&4&&p!==(p=k[2].hints.group+"")&&X(c,p)},d(k){k&&y(e),f=!1,Je(w)}}}function Jo(o){let e,t,n,i;const a=[Io,So],s=[];function l(r,h){return r[4]!==void 0?0:1}return e=l(o),t=s[e]=a[e](o),{c(){t.c(),n=ie()},m(r,h){s[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?s[e].p(r,h):(G(),m(s[d],1,1,()=>{s[d]=null}),Y(),t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n))},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){s[e].d(r),r&&y(n)}}}function Ze(o){return o===void 0?!1:(o.type&&(o=o.type),o==="boolean"?!0:Array.isArray(o)?o.some(e=>Ze(e)):!1)}function Wo(o,e,t){var q,I,M,J,E;let n,{state:i}=e,{path:a=[]}=e,{schema:s}=e,{startInEditModeIfUnset:l=s.hints&&!s.hints.ifunset}=e;const r=((q=s.hints)==null?void 0:q.typehint)==="translation"||((I=s.hints)==null?void 0:I.typehint)==="rendered"||ko.isTranslation(s);let h=s.hints.typehint??"string",d=(s.hints.inline??s.path.join("."))+(r?" <b>{translated(value)}</b>":" <b>{value}</b>");s.type==="boolean"&&(d=void 0),(s.hints.typehint==="tag"||s.hints.typehint==="simple_tag")&&(d="{tags()}");let p=(M=s.hints.typehelper)==null?void 0:M.split(","),c=s.hints.inline!==void 0;if(r&&(h="translation",s.hints.inline)){const W=s.hints.inline;d=W,c=!1,p=[W.substring(0,W.indexOf("{")),W.substring(W.indexOf("}")+1)]}h.endsWith("[]")&&(h=h.substring(0,h.length-2));const f={id:a.join("_"),render:d,question:s.hints.question,questionHint:Le(s.description),freeform:s.type==="boolean"?void 0:{key:"value",type:h,inline:c,helperArgs:p}};s.hints.default?f.mappings=[{if:"value=",then:a.at(-1)+" is not set. The default value <b>"+s.hints.default+"</b> will be used. "+(s.hints.ifunset??""),hideInAnswer:Ze(s.type)}]:s.required||(f.mappings=[{if:"value=",then:a.at(-1)+" is not set. "+(s.hints.ifunset??"")}]),Ze(s.type)&&(f.mappings=f.mappings??[],f.mappings.push({if:"value=true",then:((J=s.hints)==null?void 0:J.iftrue)??"Yes"},{if:"value=false",then:((E=s.hints)==null?void 0:E.iffalse)??"No"})),s.hints.suggestions&&(f.mappings||(f.mappings=[]),f.mappings.push(...s.hints.suggestions));let w,k,T=i.messagesFor(a);te(o,T,W=>t(5,n=W));try{w=new Ue(f,"config based on "+s.path.join("."))}catch(W){console.error(W,w),k=a.join(".")+" "+W}let L=i.getCurrentValueFor(a),N=L===void 0&&l;const D=new _e({value:L});try{Xe(i.register(a,D.map(W=>{const j=W.value;if(typeof j=="object")return{...j};if(s.type==="boolean")return j==null?j:j==="true"||j==="yes"||j==="1";if(Ze(s.type)){if(j==="true"||j==="yes"||j==="1")return!0;if(j==="false"||j==="no"||j==="0"||j===!1)return!1}return s.type==="number"?j===""||j===null||isNaN(Number(j))?void 0:Number(j):r&&typeof j=="string"?j===""?{}:JSON.parse(j):j}),r))}catch(W){console.error("Could not register",a,"due to",W)}const R=()=>console.log(s),S=()=>console.log(s);return o.$$set=W=>{"state"in W&&t(0,i=W.state),"path"in W&&t(1,a=W.path),"schema"in W&&t(2,s=W.schema),"startInEditModeIfUnset"in W&&t(9,l=W.startInEditModeIfUnset)},[i,a,s,w,k,n,T,N,D,l,R,S]}class xe extends ae{constructor(e){super(),re(this,e,Wo,Jo,le,{state:0,path:1,schema:2,startInEditModeIfUnset:9})}}function Tt(o,e,t){const n=o.slice();return n[18]=e[t],n}const Mo=o=>({}),qt=o=>({class:"my-4 self-end"});function kt(o,e,t){const n=o.slice();return n[21]=e[t],n}function xt(o){let e,t;return{c(){e=O("TagRendering "),t=O(o[4])},m(n,i){b(n,e,i),b(n,t,i)},p(n,i){i&16&&X(t,n[4])},d(n){n&&y(e),n&&y(t)}}}function $t(o){let e=o[2].hints.question+"",t;return{c(){t=O(e)},m(n,i){b(n,t,i)},p(n,i){i&4&&e!==(e=n[2].hints.question+"")&&X(t,e)},d(n){n&&y(t)}}}function Oo(o){let e,t=o[2].hints.question&&$t(o);return{c(){t&&t.c(),e=ie()},m(n,i){t&&t.m(n,i),b(n,e,i)},p(n,i){n[2].hints.question?t?t.p(n,i):(t=$t(n),t.c(),t.m(e.parentNode,e)):t&&(t.d(1),t=null)},d(n){t&&t.d(n),n&&y(e)}}}function Ct(o){let e,t;return e=new ze({props:{src:o[3]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&8&&(a.src=n[3]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function At(o){let e,t;return e=new ot({props:{message:o[21]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&32&&(a.message=n[21]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Do(o){let e,t;return e=new Be({props:{selectedElement:o[0].exampleFeature,config:o[18],editingEnabled:new Ii(!0),state:o[0],tags:o[10]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&1&&(a.selectedElement=n[0].exampleFeature),i&64&&(a.config=n[18]),i&1&&(a.state=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function No(o){let e,t,n,i,a;return n=new ze({props:{src:o[18].metacondition.asHumanString(!0,!1,{})}}),{c(){e=O(`This tagRendering is currently not shown. It will appear if the feature matches the
        metacondition
        `),t=v("b"),x(n.$$.fragment),i=O(`
        For a breakdown of usable meta conditions, go to a mapcomplete theme > settings and enable debug-data.
        The meta-tags will appear at the bottom`)},m(s,l){b(s,e,l),b(s,t,l),$(n,t,null),b(s,i,l),a=!0},p(s,l){const r={};l&64&&(r.src=s[18].metacondition.asHumanString(!0,!1,{})),n.$set(r)},i(s){a||(u(n.$$.fragment,s),a=!0)},o(s){m(n.$$.fragment,s),a=!1},d(s){s&&y(e),s&&y(t),C(n),s&&y(i)}}}function Fo(o){let e,t,n,i,a;return n=new ze({props:{src:o[18].condition.asHumanString(!0,!1,{})}}),{c(){e=O(`This tagRendering is currently not shown. It will appear if the feature matches the
        condition
        `),t=v("b"),x(n.$$.fragment),i=O(`

        Try to answer the relevant question above`)},m(s,l){b(s,e,l),b(s,t,l),$(n,t,null),b(s,i,l),a=!0},p(s,l){const r={};l&64&&(r.src=s[18].condition.asHumanString(!0,!1,{})),n.$set(r)},i(s){a||(u(n.$$.fragment,s),a=!0)},o(s){m(n.$$.fragment,s),a=!1},d(s){s&&y(e),s&&y(t),C(n),s&&y(i)}}}function Lo(o){let e,t,n=o[18].error+"",i;return{c(){e=v("div"),t=O("Could not create a preview of this tagRendering: "),i=O(n),_(e,"class","alert")},m(a,s){b(a,e,s),g(e,t),g(e,i)},p(a,s){s&64&&n!==(n=a[18].error+"")&&X(i,n)},i:z,o:z,d(a){a&&y(e)}}}function Rt(o){let e,t,n,i,a,s;const l=[Lo,Fo,No,Do],r=[];function h(d,p){return p&192&&(e=null),p&192&&(t=null),d[18].error!==void 0?0:(e==null&&(e=!!(d[18].condition&&!d[18].condition.matchesProperties(d[7]))),e?1:(t==null&&(t=!!(d[18].metacondition&&!d[18].metacondition.matchesProperties(d[7]))),t?2:3))}return n=h(o,-1),i=r[n]=l[n](o),{c(){i.c(),a=ie()},m(d,p){r[n].m(d,p),b(d,a,p),s=!0},p(d,p){let c=n;n=h(d,p),n===c?r[n].p(d,p):(G(),m(r[c],1,1,()=>{r[c]=null}),Y(),i=r[n],i?i.p(d,p):(i=r[n]=l[n](d),i.c()),u(i,1),i.m(a.parentNode,a))},i(d){s||(u(i),s=!0)},o(d){m(i),s=!1},d(d){r[n].d(d),d&&y(a)}}}function Eo(o){let e,t,n,i,a,s,l,r,h,d,p,c,f=o[4]&&xt(o);i=new qe({props:{clss:"primary",$$slots:{default:[Oo]},$$scope:{ctx:o}}}),i.$on("click",o[13]);let w=o[3]&&Ct(o),k=o[5],T=[];for(let I=0;I<k.length;I+=1)T[I]=At(kt(o,k,I));const L=I=>m(T[I],1,1,()=>{T[I]=null}),N=o[12].default,D=be(N,o,o[14],qt);let R=o[6],S=[];for(let I=0;I<R.length;I+=1)S[I]=Rt(Tt(o,R,I));const q=I=>m(S[I],1,1,()=>{S[I]=null});return{c(){e=v("div"),t=v("div"),f&&f.c(),n=A(),x(i.$$.fragment),a=A(),w&&w.c(),s=A();for(let I=0;I<T.length;I+=1)T[I].c();l=A(),D&&D.c(),r=A(),h=v("div"),d=v("h3"),d.textContent="Preview of this question",p=A();for(let I=0;I<S.length;I+=1)S[I].c();_(t,"class","interactive border-interactive m-4 flex w-full flex-col"),_(h,"class","m-4 flex w-full flex-col"),_(e,"class","flex")},m(I,M){b(I,e,M),g(e,t),f&&f.m(t,null),g(t,n),$(i,t,null),g(t,a),w&&w.m(t,null),g(t,s);for(let J=0;J<T.length;J+=1)T[J]&&T[J].m(t,null);g(t,l),D&&D.m(t,null),g(e,r),g(e,h),g(h,d),g(h,p);for(let J=0;J<S.length;J+=1)S[J]&&S[J].m(h,null);c=!0},p(I,[M]){I[4]?f?f.p(I,M):(f=xt(I),f.c(),f.m(t,n)):f&&(f.d(1),f=null);const J={};if(M&16388&&(J.$$scope={dirty:M,ctx:I}),i.$set(J),I[3]?w?(w.p(I,M),M&8&&u(w,1)):(w=Ct(I),w.c(),u(w,1),w.m(t,s)):w&&(G(),m(w,1,1,()=>{w=null}),Y()),M&32){k=I[5];let E;for(E=0;E<k.length;E+=1){const W=kt(I,k,E);T[E]?(T[E].p(W,M),u(T[E],1)):(T[E]=At(W),T[E].c(),u(T[E],1),T[E].m(t,l))}for(G(),E=k.length;E<T.length;E+=1)L(E);Y()}if(D&&D.p&&(!c||M&16384)&&ye(D,N,I,I[14],c?ve(N,I[14],M,Mo):we(I[14]),qt),M&1217){R=I[6];let E;for(E=0;E<R.length;E+=1){const W=Tt(I,R,E);S[E]?(S[E].p(W,M),u(S[E],1)):(S[E]=Rt(W),S[E].c(),u(S[E],1),S[E].m(h,null))}for(G(),E=R.length;E<S.length;E+=1)q(E);Y()}},i(I){if(!c){u(i.$$.fragment,I),u(w);for(let M=0;M<k.length;M+=1)u(T[M]);u(D,I);for(let M=0;M<R.length;M+=1)u(S[M]);c=!0}},o(I){m(i.$$.fragment,I),m(w),T=T.filter(Boolean);for(let M=0;M<T.length;M+=1)m(T[M]);m(D,I),S=S.filter(Boolean);for(let M=0;M<S.length;M+=1)m(S[M]);c=!1},d(I){I&&y(e),f&&f.d(),C(i),w&&w.d(),ue(T,I),D&&D.d(I),ue(S,I)}}}function Po(o,e,t){let n,i,a,s,{$$slots:l={},$$scope:r}=e,{state:h}=e,{path:d}=e,{schema:p}=e,c=h.getStoreFor(d),f={};for(let S of Dn){if(S.labels)for(let q of S.labels)f[q]=(f[q]??[]).concat(S);f[S.id]=[S]}let k=c.map(S=>typeof S=="string"?f[S]:[S]).map(S=>S?(console.log("Regenerating configs"),S.map(q=>{try{return new Ue(q)}catch(I){return{error:I}}})):[{error:"No configuartions found"}]);te(o,k,S=>t(6,a=S));let T=c.mapD(S=>{if(S!=null&&S.id)return S.id;if(typeof S=="string")return S});te(o,T,S=>t(4,n=S));let L=h.testTags;te(o,L,S=>t(7,s=S));let N=h.messagesFor(d);te(o,N,S=>t(5,i=S));let D=p.description;if(D)try{D=Le(D)}catch{console.error("Could not convert description to markdown",{description:D})}const R=()=>h.highlightedItem.setData({path:d,schema:p});return o.$$set=S=>{"state"in S&&t(0,h=S.state),"path"in S&&t(1,d=S.path),"schema"in S&&t(2,p=S.schema),"$$scope"in S&&t(14,r=S.$$scope)},[h,d,p,D,n,i,a,s,k,T,L,N,l,R,r]}class Hn extends ae{constructor(e){super(),re(this,e,Po,Eo,le,{state:0,path:1,schema:2})}}function St(o,e,t){const n=o.slice();return n[24]=e[t],n}function It(o,e,t){const n=o.slice();return n[21]=e[t],n}function jt(o){let e,t=o[2].hints.title+"",n,i,a,s=o[2].description+"",l;return{c(){e=v("h3"),n=O(t),i=A(),a=v("div"),l=O(s)},m(r,h){b(r,e,h),g(e,n),b(r,i,h),b(r,a,h),g(a,l)},p(r,h){h&4&&t!==(t=r[2].hints.title+"")&&X(n,t),h&4&&s!==(s=r[2].description+"")&&X(l,s)},d(r){r&&y(e),r&&y(i),r&&y(a)}}}function Ho(o){let e,t,n,i,a,s,l;t=new Be({props:{config:o[10],selectedElement:void 0,state:o[0],tags:o[9]}});const r=[zo,Uo],h=[];function d(p,c){return p[3]!==void 0?0:p[7].length>0?1:-1}return~(i=d(o))&&(a=h[i]=r[i](o)),{c(){e=v("div"),x(t.$$.fragment),n=A(),a&&a.c(),s=ie()},m(p,c){b(p,e,c),$(t,e,null),b(p,n,c),~i&&h[i].m(p,c),b(p,s,c),l=!0},p(p,c){const f={};c&1&&(f.state=p[0]),t.$set(f);let w=i;i=d(p),i===w?~i&&h[i].p(p,c):(a&&(G(),m(h[w],1,1,()=>{h[w]=null}),Y()),~i?(a=h[i],a?a.p(p,c):(a=h[i]=r[i](p),a.c()),u(a,1),a.m(s.parentNode,s)):a=null)},i(p){l||(u(t.$$.fragment,p),u(a),l=!0)},o(p){m(t.$$.fragment,p),m(a),l=!1},d(p){p&&y(e),C(t),p&&y(n),~i&&h[i].d(p),p&&y(s)}}}function Bo(o){let e,t=o[11].builtin+"",n,i;return{c(){e=O("This object refers to "),n=O(t),i=O(` and overrides some properties. This cannot be edited
    with MapComplete Studio`)},m(a,s){b(a,e,s),b(a,n,s),b(a,i,s)},p:z,i:z,o:z,d(a){a&&y(e),a&&y(n),a&&y(i)}}}function Uo(o){let e,t,n=o[7],i=[];for(let s=0;s<n.length;s+=1)i[s]=Jt(St(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l&128){n=s[7];let r;for(r=0;r<n.length;r+=1){const h=St(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Jt(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function zo(o){let e,t,n=o[4],i=[];for(let s=0;s<n.length;s+=1)i[s]=Wt(It(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l&113){n=s[4];let r;for(r=0;r<n.length;r+=1){const h=It(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Wt(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function Jt(o){let e,t;return e=new ot({props:{message:o[24]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&128&&(a.message=n[24]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Vo(o){let e,t,n=o[21].path.join(".")+"",i;return{c(){e=v("span"),t=O("Omitted expert question "),i=O(n),_(e,"class","subtle")},m(a,s){b(a,e,s),g(e,t),g(e,i)},p(a,s){s&16&&n!==(n=a[21].path.join(".")+"")&&X(i,n)},i:z,o:z,d(a){a&&y(e)}}}function Qo(o){var n,i;let e,t;return e=new Ve({props:{state:o[0],schema:o[21],path:[...o[5],((i=(n=o[21])==null?void 0:n.path)==null?void 0:i.at(-1))??"???"]}}),{c(){x(e.$$.fragment)},m(a,s){$(e,a,s),t=!0},p(a,s){var r,h;const l={};s&1&&(l.state=a[0]),s&16&&(l.schema=a[21]),s&48&&(l.path=[...a[5],((h=(r=a[21])==null?void 0:r.path)==null?void 0:h.at(-1))??"???"]),e.$set(l)},i(a){t||(u(e.$$.fragment,a),t=!0)},o(a){m(e.$$.fragment,a),t=!1},d(a){C(e,a)}}}function Wt(o){let e,t,n,i;const a=[Qo,Vo],s=[];function l(r,h){var d;return r[6]||((d=r[21].hints)==null?void 0:d.group)!=="expert"?0:window.location.hostname==="127.0.0.1"?1:-1}return~(e=l(o))&&(t=s[e]=a[e](o)),{c(){t&&t.c(),n=ie()},m(r,h){~e&&s[e].m(r,h),b(r,n,h),i=!0},p(r,h){let d=e;e=l(r),e===d?~e&&s[e].p(r,h):(t&&(G(),m(s[d],1,1,()=>{s[d]=null}),Y()),~e?(t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n)):t=null)},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){~e&&s[e].d(r),r&&y(n)}}}function Go(o){let e,t,n,i=o[1].join(".")+"",a,s,l,r=o[2].hints.typehint+"",h,d,p;return{c(){e=v("span"),t=O("SchemaBasedMultiType "),n=v("b"),a=O(i),s=A(),l=v("span"),h=O(r),_(l,"class","cursor-pointer"),_(e,"class","subtle")},m(c,f){b(c,e,f),g(e,t),g(e,n),g(n,a),g(e,s),g(e,l),g(l,h),d||(p=Z(l,"click",o[14]),d=!0)},p(c,f){f&2&&i!==(i=c[1].join(".")+"")&&X(a,i),f&4&&r!==(r=c[2].hints.typehint+"")&&X(h,r)},d(c){c&&y(e),d=!1,p()}}}function Yo(o){let e,t,n,i,a,s,l=o[2].hints.title!==void 0&&jt(o);const r=[Bo,Ho],h=[];function d(c,f){return c[12]?0:1}n=d(o),i=h[n]=r[n](o);let p=window.location.hostname==="127.0.0.1"&&Go(o);return{c(){e=v("div"),l&&l.c(),t=A(),i.c(),a=A(),p&&p.c(),_(e,"class","m-1 flex flex-col gap-y-2 border-2 border-dashed border-gray-300 p-2")},m(c,f){b(c,e,f),l&&l.m(e,null),g(e,t),h[n].m(e,null),g(e,a),p&&p.m(e,null),s=!0},p(c,[f]){c[2].hints.title!==void 0?l?l.p(c,f):(l=jt(c),l.c(),l.m(e,t)):l&&(l.d(1),l=null),i.p(c,f),window.location.hostname==="127.0.0.1"&&p.p(c,f)},i(c){s||(u(i),s=!0)},o(c){m(i),s=!1},d(c){c&&y(e),l&&l.d(),h[n].d(),p&&p.d()}}}function Ko(o,e,t){var M;let n,i,{state:a}=e,{path:s=[]}=e,{schema:l}=e,r=a.expertMode;te(o,r,J=>t(6,n=J));const h=l.hints.typesdefault?Number(l.hints.typesdefault):void 0,d=(M=l.type)==null?void 0:M.findIndex(J=>J.type==="boolean"),p=l.hints.types.split(";");d>=0&&p.splice(d);let c=!1;{const J=Array.isArray(l.type)?l.type[l.type.length-1].type:[];c=J==="string"||Array.isArray(J)&&J.some(E=>E==="string")}c&&p.splice(p.length-1,1);const f={id:"TYPE_OF:"+s.join("_"),question:"Which subcategory is needed for "+l.path.at(-1)+"?",questionHint:Le(l.description),mappings:p.map(J=>J.trim()).filter(J=>J.length>0).map((J,E)=>({if:"chosen_type_index="+E,addExtraTags:["value="],then:J+(E===h?" (Default)":"")})),render:c?l.hints.inline??"Use a hardcoded value: <b>{value}</b>":void 0,freeform:c?{key:"value",inline:!0,type:l.hints.typehint,addExtraTags:["chosen_type_index="]}:void 0};let w=new _e({});l.hints.ifunset&&f.mappings.push({if:{and:["value=","chosen_type_index="]},then:l.hints.ifunset}),l.hints.suggestions&&f.mappings.push(...l.hints.suggestions),d>=0&&f.mappings.unshift({if:"value=true",then:l.hints.iftrue??"Yes",addExtraTags:["chosen_type_index="]},{if:"value=false",then:l.hints.iffalse??"No",addExtraTags:["chosen_type_index="]});const k=new Ue(f,"config based on "+l.path.join("."));let T=h;const L=a.getCurrentValueFor(s);let N=(L==null?void 0:L.override)!==void 0;if(d>=0&&(L===!0||L===!1))w.setData({value:""+L});else if(c&&typeof L=="string")w.setData({value:L}),T=void 0;else if(L){const J=[];e:for(let E=0;E<l.type.length;E++){const W=l.type[E];let j=0;for(const F of Object.keys(W.properties??{}))L[F]&&j++;if(W.required){let F=0;for(const V of W.required){if(L[V]===void 0)continue e;F++}J.push({index:E,matchingPropertiesCount:F,optionalMatches:j})}else J.push({index:E,matchingPropertiesCount:0,optionalMatches:j})}J.sort((E,W)=>W.optionalMatches-E.optionalMatches),J.sort((E,W)=>W.matchingPropertiesCount-E.matchingPropertiesCount),J.length>0&&(T=J[0].index,w.setData({chosen_type_index:""+T}))}else h!==void 0?w.setData({chosen_type_index:""+h}):T=h;if(d>=0||c){const J=w.mapD(E=>E.chosen_type_index?"":c?E.value:E.value==="true");Xe(a.register(s,J))}let D=[],R=s;const S=a.getStoreFor(s);Xe(w.addCallbackAndRun(J=>{if(J.value!==void 0&&J.value!==""){t(3,T=void 0);return}const E=T;t(3,T=J.chosen_type_index?Number(J.chosen_type_index):h);const W=l.type[T];if(T!==E){t(4,D=[]);const F=a.getCurrentValueFor(s)??{};for(const V of(W==null?void 0:W.required)??[])F[V]??(F[V]={});S.setData(F)}if(!W)return;t(5,R=s);const j=s.filter(F=>typeof F=="string");if(W.$ref==="#/definitions/Record<string,string>"){const F=a.getTranslationAt(j);D.push(F),t(5,R=s.slice(0,s.length-2));return}if(W.properties)for(const F of Object.keys(W.properties))D.push(...a.getSchema([...j,F]))}));let q=a.messagesFor(s);te(o,q,J=>t(7,i=J));const I=()=>console.log(l);return o.$$set=J=>{"state"in J&&t(0,a=J.state),"path"in J&&t(1,s=J.path),"schema"in J&&t(2,l=J.schema)},[a,s,l,T,D,R,n,i,r,w,k,L,N,q,I]}class Bn extends ae{constructor(e){super(),re(this,e,Ko,Yo,le,{state:0,path:1,schema:2})}}const Zo=o=>({}),Mt=o=>({});function Ot(o,e,t){const n=o.slice();return n[32]=e[t],n[34]=t,n}function Dt(o,e,t){const n=o.slice();return n[36]=e[t],n}function Nt(o,e,t){const n=o.slice();return n[32]=e[t],n[34]=t,n}function Ft(o,e,t){const n=o.slice();return n[29]=e[t],n}function Xo(o){let e,t=o[0].description+"",n;return{c(){e=v("span"),n=O(t),_(e,"class","subtle")},m(i,a){b(i,e,a),g(e,n)},p(i,a){a[0]&1&&t!==(t=i[0].description+"")&&X(n,t)},d(i){i&&y(e)}}}function es(o){let e,t,n=o[6],i=[];for(let s=0;s<n.length;s+=1)i[s]=Pt(Ot(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l[0]&127819){n=s[6];let r;for(r=0;r<n.length;r+=1){const h=Ot(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Pt(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function ts(o){let e,t,n=o[6],i=[];for(let s=0;s<n.length;s+=1)i[s]=Ht(Nt(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l[0]&20547){n=s[6];let r;for(r=0;r<n.length;r+=1){const h=Nt(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Ht(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function ns(o){let e,t,n,i=o[7].length>0&&Bt(o);return{c(){e=O(`No values are defined
    `),i&&i.c(),t=ie()},m(a,s){b(a,e,s),i&&i.m(a,s),b(a,t,s),n=!0},p(a,s){a[7].length>0?i?(i.p(a,s),s[0]&128&&u(i,1)):(i=Bt(a),i.c(),u(i,1),i.m(t.parentNode,t)):i&&(G(),m(i,1,1,()=>{i=null}),Y())},i(a){n||(u(i),n=!0)},o(a){m(i),n=!1},d(a){a&&y(e),i&&i.d(a),a&&y(t)}}}function is(o){let e;return{c(){e=O("No array defined")},m(t,n){b(t,e,n)},p:z,i:z,o:z,d(t){t&&y(e)}}}function os(o){let e,t,n,i,a,s,l,r,h,d,p;r=new ct({props:{class:"h-4 w-4"}});function c(){return o[19](o[34])}return{c(){e=v("div"),t=v("h3"),n=O(o[3]),i=A(),a=O(o[34]),s=A(),l=v("button"),x(r.$$.fragment),_(t,"class","m-0"),_(l,"class","h-fit w-fit rounded-full border border-black p-1"),_(e,"class","flex items-center justify-between")},m(f,w){b(f,e,w),g(e,t),g(t,n),g(t,i),g(t,a),g(e,s),g(e,l),$(r,l,null),h=!0,d||(p=Z(l,"click",c),d=!0)},p(f,w){o=f,(!h||w[0]&8)&&X(n,o[3])},i(f){h||(u(r.$$.fragment,f),h=!0)},o(f){m(r.$$.fragment,f),h=!1},d(f){f&&y(e),C(r),d=!1,p()}}}function ss(o){let e,t,n=o[9],i=[];for(let s=0;s<n.length;s+=1)i[s]=Lt(Dt(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l[0]&4610){n=s[9];let r;for(r=0;r<n.length;r+=1){const h=Dt(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Lt(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function as(o){let e,t;return e=new Bn({props:{state:o[1],path:o[12](o[34],[]),schema:o[13]()}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&2&&(a.state=n[1]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function rs(o){let e,t;return e=new Hn({props:{state:o[1],path:o[12](o[34],[]),schema:o[0],$$slots:{default:[hs]},$$scope:{ctx:o}}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&2&&(a.state=n[1]),i[0]&1&&(a.schema=n[0]),i[0]&134217792&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Lt(o){let e,t;return e=new Ve({props:{state:o[1],path:o[12](o[34],[o[36].path.at(-1)]),schema:o[36]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&2&&(a.state=n[1]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function ls(o){let e,t,n,i,a;function s(){return o[21](o[34])}function l(){return o[22](o[34])}return{c(){e=v("button"),e.textContent="Move to front",t=A(),n=v("button"),n.textContent="Move up"},m(r,h){b(r,e,h),b(r,t,h),b(r,n,h),i||(a=[Z(e,"click",s),Z(n,"click",l)],i=!0)},p(r,h){o=r},d(r){r&&y(e),r&&y(t),r&&y(n),i=!1,Je(a)}}}function Et(o){let e,t,n,i,a;function s(){return o[23](o[34])}function l(){return o[24](o[34])}return{c(){e=v("button"),e.textContent="Move down",t=A(),n=v("button"),n.textContent="Move to back"},m(r,h){b(r,e,h),b(r,t,h),b(r,n,h),i||(a=[Z(e,"click",s),Z(n,"click",l)],i=!0)},p(r,h){o=r},d(r){r&&y(e),r&&y(t),r&&y(n),i=!1,Je(a)}}}function hs(o){let e,t,n,i,a,s,l,r,h;t=new ct({props:{class:"h-4 w-4"}});function d(){return o[20](o[34])}let p=o[34]>0&&ls(o),c=o[34]+1<o[6].length&&Et(o);return{c(){e=v("button"),x(t.$$.fragment),n=O(`
              Delete this question`),i=A(),p&&p.c(),a=A(),c&&c.c(),s=ie()},m(f,w){b(f,e,w),$(t,e,null),g(e,n),b(f,i,w),p&&p.m(f,w),b(f,a,w),c&&c.m(f,w),b(f,s,w),l=!0,r||(h=Z(e,"click",d),r=!0)},p(f,w){o=f,o[34]>0&&p.p(o,w),o[34]+1<o[6].length?c?c.p(o,w):(c=Et(o),c.c(),c.m(s.parentNode,s)):c&&(c.d(1),c=null)},i(f){l||(u(t.$$.fragment,f),l=!0)},o(f){m(t.$$.fragment,f),l=!1},d(f){f&&y(e),C(t),f&&y(i),p&&p.d(f),f&&y(a),c&&c.d(f),f&&y(s),r=!1,h()}}}function Pt(o){let e,t,n,i,a,s,l=!o[8]&&os(o);const r=[rs,as,ss],h=[];function d(p,c){return p[8]?0:p[0].hints.types?1:2}return n=d(o),i=h[n]=r[n](o),{c(){l&&l.c(),e=A(),t=v("div"),i.c(),a=A(),_(t,"class","border border-black")},m(p,c){l&&l.m(p,c),b(p,e,c),b(p,t,c),h[n].m(t,null),g(t,a),s=!0},p(p,c){p[8]||l.p(p,c);let f=n;n=d(p),n===f?h[n].p(p,c):(G(),m(h[f],1,1,()=>{h[f]=null}),Y(),i=h[n],i?i.p(p,c):(i=h[n]=r[n](p),i.c()),u(i,1),i.m(t,a))},i(p){s||(u(l),u(i),s=!0)},o(p){m(l),m(i),s=!1},d(p){l&&l.d(p),p&&y(e),p&&y(t),h[n].d()}}}function Ht(o){let e,t,n,i,a,s,l,r,h;t=new xe({props:{state:o[1],schema:o[0],path:o[12](o[34],[])}}),a=new ct({props:{class:"h-4 w-4"}});function d(){return o[18](o[34])}return{c(){e=v("div"),x(t.$$.fragment),n=A(),i=v("button"),x(a.$$.fragment),s=A(),_(i,"class","h-fit w-fit rounded-full border border-black p-1"),_(e,"class","flex w-full")},m(p,c){b(p,e,c),$(t,e,null),g(e,n),g(e,i),$(a,i,null),g(e,s),l=!0,r||(h=Z(i,"click",d),r=!0)},p(p,c){o=p;const f={};c[0]&2&&(f.state=o[1]),c[0]&1&&(f.schema=o[0]),t.$set(f)},i(p){l||(u(t.$$.fragment,p),u(a.$$.fragment,p),l=!0)},o(p){m(t.$$.fragment,p),m(a.$$.fragment,p),l=!1},d(p){p&&y(e),C(t),C(a),r=!1,h()}}}function Bt(o){let e,t,n=o[7],i=[];for(let s=0;s<n.length;s+=1)i[s]=Ut(Ft(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l[0]&128){n=s[7];let r;for(r=0;r<n.length;r+=1){const h=Ft(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Ut(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function Ut(o){let e,t;return e=new ot({props:{message:o[29]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&128&&(a.message=n[29]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function zt(o){let e,t,n;return{c(){e=v("button"),e.textContent="Add a builtin tagRendering"},m(i,a){b(i,e,a),t||(n=Z(e,"click",o[26]),t=!0)},p:z,d(i){i&&y(e),t=!1,n()}}}function ds(o){let e,t,n=o[0].path.at(-1)+"",i,a,s,l,r,h,d,p,c,f,w,k,T,L,N,D,R,S=o[9].length>0&&Xo(o);const q=[is,ns,ts,es],I=[];function M(j,F){return j[6]===void 0?0:j[6].length===0?1:j[9].length===0?2:3}l=M(o),r=I[l]=q[l](o);let J=o[2].length===1&&o[2][0]==="tagRenderings"&&zt(o);const E=o[17]["extra-button"],W=be(E,o,o[27],Mt);return{c(){e=v("div"),t=v("h3"),i=O(n),a=A(),S&&S.c(),s=A(),r.c(),h=A(),d=v("div"),p=v("button"),c=O("Add "),f=O(o[4]),w=A(),k=O(o[3]),T=A(),J&&J.c(),L=A(),W&&W.c(),_(d,"class","flex"),_(e,"class","pl-2")},m(j,F){b(j,e,F),g(e,t),g(t,i),g(e,a),S&&S.m(e,null),g(e,s),I[l].m(e,null),g(e,h),g(e,d),g(d,p),g(p,c),g(p,f),g(p,w),g(p,k),g(d,T),J&&J.m(d,null),g(d,L),W&&W.m(d,null),N=!0,D||(R=Z(p,"click",o[25]),D=!0)},p(j,F){(!N||F[0]&1)&&n!==(n=j[0].path.at(-1)+"")&&X(i,n),j[9].length>0&&S.p(j,F);let V=l;l=M(j),l===V?I[l].p(j,F):(G(),m(I[V],1,1,()=>{I[V]=null}),Y(),r=I[l],r?r.p(j,F):(r=I[l]=q[l](j),r.c()),u(r,1),r.m(e,h)),(!N||F[0]&16)&&X(f,j[4]),(!N||F[0]&8)&&X(k,j[3]),j[2].length===1&&j[2][0]==="tagRenderings"?J?J.p(j,F):(J=zt(j),J.c(),J.m(d,L)):J&&(J.d(1),J=null),W&&W.p&&(!N||F[0]&134217728)&&ye(W,E,j,j[27],N?ve(E,j[27],F,Zo):we(j[27]),Mt)},i(j){N||(u(r),u(W,j),N=!0)},o(j){m(r),m(W,j),N=!1},d(j){j&&y(e),S&&S.d(),I[l].d(),J&&J.d(),W&&W.d(j),D=!1,R()}}}function ps(o,e,t){let n,i,{$$slots:a={},$$scope:s}=e,{state:l}=e,{schema:r}=e,h=r.path.at(-1),d=h;h!=null&&h.endsWith("s")&&(d=h.slice(0,h.length-1));let p="a";d!=null&&d.match(/^[aeoui]/)&&(p="an");let{path:c=[]}=e;const f=c.length===1&&c[0]==="tagRenderings";f&&(r={...r},r.description=void 0);const w=l.getSchemaStartingWith(r.path).filter(H=>H.path.length-1===r.path.length);let k=l.messagesFor(c);te(o,k,H=>t(7,i=H));const T=l.getStoreFor(c);te(o,T,H=>t(6,n=H)),T.data===void 0&&T.setData([]);function L(H){T.data===void 0&&T.setData([]),T.data.push(H),T.ping(),f&&l.highlightedItem.setData({path:[...c,T.data.length-1],schema:r})}function N(H,ee){const K=[...c,H],se=[...ee];for(const oe of c)if(se[0]===oe)se.splice(0,1);else break;return K.push(...se),K}function D(){const H={...r};return H.hints.typehint=void 0,H}function R(H){T.data.splice(H,1),T.ping()}function S(H,ee){const K=T.data[H];t(5,T.data[H]=T.data[ee],T),t(5,T.data[ee]=K,T),T.ping()}function q(H,ee){const K=T.data[H];T.data.splice(H,1),T.data.splice(ee,0,K),T.ping()}const I=H=>{R(H)},M=H=>{R(H)},J=H=>{R(H)},E=H=>{q(H,0)},W=H=>{S(H,H-1)},j=H=>{S(H,H+1)},F=H=>{q(H,n.length-1)},V=()=>L(),B=()=>{L("images")};return o.$$set=H=>{"state"in H&&t(1,l=H.state),"schema"in H&&t(0,r=H.schema),"path"in H&&t(2,c=H.path),"$$scope"in H&&t(27,s=H.$$scope)},[r,l,c,d,p,T,n,i,f,w,k,L,N,D,R,S,q,a,I,M,J,E,W,j,F,V,B,s]}class Un extends ae{constructor(e){super(),re(this,e,ps,ds,le,{state:1,schema:0,path:2},null,[-1,-1])}}function cs(o){let e,t,n;return t=new Be({props:{config:o[2],selectedElement:void 0,state:o[0],tags:o[1]}}),{c(){e=v("div"),x(t.$$.fragment)},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,[a]){const s={};a&1&&(s.state=i[0]),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function fs(o,e,t){let{schema:n}=e,{state:i}=e,{path:a=[]}=e;const s={mappings:n.hints.suggestions,multiAnswer:!0,id:"multi_anwser_"+a.join("_"),question:n.hints.question},l=new _e({});{const h=i.getCurrentValueFor(a);h&&h.length>0&&l.setData({value:h.join(";")})}l.addCallbackD(h=>{var p;const d=(p=h.value)==null?void 0:p.split(";");d&&i.setValueAt(a,d)});const r=new Ue(s);return o.$$set=h=>{"schema"in h&&t(3,n=h.schema),"state"in h&&t(0,i=h.state),"path"in h&&t(4,a=h.path)},[i,l,r,n,a]}class us extends ae{constructor(e){super(),re(this,e,fs,cs,le,{schema:3,state:0,path:4})}}function gs(o){let e,t,n=o[0].path.join(".")+"",i,a,s=o[0].hints.group+"",l;return{c(){e=v("div"),t=O("Not showing SBI "),i=O(n),a=O(" due to group "),l=O(s),_(e,"class","subtle")},m(r,h){b(r,e,h),g(e,t),g(e,i),g(e,a),g(e,l)},p(r,h){h&1&&n!==(n=r[0].path.join(".")+"")&&X(i,n),h&1&&s!==(s=r[0].hints.group+"")&&X(l,s)},i:z,o:z,d(r){r&&y(e)}}}function ms(o){let e,t,n,i,a;const s=[_s,vs,ws,ys,bs],l=[];function r(h,d){var p,c,f;return d&1&&(e=null),e==null&&(e=!!((c=(p=h[0].hints)==null?void 0:p.typehint)!=null&&c.endsWith("[]"))),e?0:h[0].type==="array"&&h[0].hints.multianswer==="true"?1:h[0].type==="array"?2:(f=h[0].hints)!=null&&f.types?3:4}return t=r(o,-1),n=l[t]=s[t](o),{c(){n.c(),i=ie()},m(h,d){l[t].m(h,d),b(h,i,d),a=!0},p(h,d){let p=t;t=r(h,d),t===p?l[t].p(h,d):(G(),m(l[p],1,1,()=>{l[p]=null}),Y(),n=l[t],n?n.p(h,d):(n=l[t]=s[t](h),n.c()),u(n,1),n.m(i.parentNode,i))},i(h){a||(u(n),a=!0)},o(h){m(n),a=!1},d(h){l[t].d(h),h&&y(i)}}}function bs(o){let e,t;return e=new xe({props:{path:o[2],state:o[1],schema:o[0]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&4&&(a.path=n[2]),i&2&&(a.state=n[1]),i&1&&(a.schema=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function ys(o){let e,t;return e=new Bn({props:{path:o[2],state:o[1],schema:o[0]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&4&&(a.path=n[2]),i&2&&(a.state=n[1]),i&1&&(a.schema=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function ws(o){let e,t;return e=new Un({props:{path:o[2],state:o[1],schema:o[0]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&4&&(a.path=n[2]),i&2&&(a.state=n[1]),i&1&&(a.schema=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function vs(o){let e,t;return e=new us({props:{path:o[2],state:o[1],schema:o[0]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&4&&(a.path=n[2]),i&2&&(a.state=n[1]),i&1&&(a.schema=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function _s(o){let e,t;return e=new Un({props:{path:o[2],state:o[1],schema:o[0]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&4&&(a.path=n[2]),i&2&&(a.state=n[1]),i&1&&(a.schema=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Ts(o){let e,t,n,i;const a=[ms,gs],s=[];function l(r,h){var d;return(((d=r[0].hints)==null?void 0:d.group)!=="expert"||r[3])&&r[0].hints.group!=="hidden"?0:window.location.hostname==="127.0.0.1"?1:-1}return~(e=l(o))&&(t=s[e]=a[e](o)),{c(){t&&t.c(),n=ie()},m(r,h){~e&&s[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?~e&&s[e].p(r,h):(t&&(G(),m(s[d],1,1,()=>{s[d]=null}),Y()),~e?(t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n)):t=null)},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){~e&&s[e].d(r),r&&y(n)}}}function qs(o,e,t){let n,{schema:i}=e,{state:a}=e,{path:s=[]}=e,l=a.expertMode;return te(o,l,r=>t(3,n=r)),o.$$set=r=>{"schema"in r&&t(0,i=r.schema),"state"in r&&t(1,a=r.state),"path"in r&&t(2,s=r.path)},[i,a,s,n,l]}class Ve extends ae{constructor(e){super(),re(this,e,qs,Ts,le,{schema:0,state:1,path:2})}}function Vt(o,e,t){const n=o.slice();return n[10]=e[t],n}function Qt(o,e,t){const n=o.slice();return n[10]=e[t],n}const ks=o=>({}),Gt=o=>({});function xs(o){let e,t,n=o[5],i=[];for(let s=0;s<n.length;s+=1)i[s]=Yt(Vt(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){e=v("div");for(let s=0;s<i.length;s+=1)i[s].c();_(e,"class","flex w-full flex-col gap-y-1 pl-2")},m(s,l){b(s,e,l);for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(e,null);t=!0},p(s,l){if(l&41){n=s[5];let r;for(r=0;r<n.length;r+=1){const h=Vt(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=Yt(h),i[r].c(),u(i[r],1),i[r].m(e,null))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){s&&y(e),ue(i,s)}}}function $s(o){let e,t,n,i,a,s,l;const r=o[7].description,h=be(r,o,o[6],Gt);let d=o[5],p=[];for(let f=0;f<d.length;f+=1)p[f]=Kt(Qt(o,d,f));const c=f=>m(p[f],1,1,()=>{p[f]=null});return{c(){e=v("div"),t=v("h3"),n=O(o[2]),i=A(),a=v("div"),h&&h.c(),s=A();for(let f=0;f<p.length;f+=1)p[f].c();_(a,"class","flex w-full flex-col gap-y-1 border border-black pl-2"),_(e,"class","flex w-full flex-col")},m(f,w){b(f,e,w),g(e,t),g(t,n),g(e,i),g(e,a),h&&h.m(a,null),g(a,s);for(let k=0;k<p.length;k+=1)p[k]&&p[k].m(a,null);l=!0},p(f,w){if((!l||w&4)&&X(n,f[2]),h&&h.p&&(!l||w&64)&&ye(h,r,f,f[6],l?ve(r,f[6],w,ks):we(f[6]),Gt),w&33){d=f[5];let k;for(k=0;k<d.length;k+=1){const T=Qt(f,d,k);p[k]?(p[k].p(T,w),u(p[k],1)):(p[k]=Kt(T),p[k].c(),u(p[k],1),p[k].m(a,null))}for(G(),k=d.length;k<p.length;k+=1)c(k);Y()}},i(f){if(!l){u(h,f);for(let w=0;w<d.length;w+=1)u(p[w]);l=!0}},o(f){m(h,f),p=p.filter(Boolean);for(let w=0;w<p.length;w+=1)m(p[w]);l=!1},d(f){f&&y(e),h&&h.d(f),ue(p,f)}}}function Cs(o){let e;return{c(){e=O("Bug: Region received empty list as configuration")},m(t,n){b(t,e,n)},p:z,i:z,o:z,d(t){t&&y(e)}}}function As(o){let e;return{c(){e=O("Bug: 'Region' received 'undefined'")},m(t,n){b(t,e,n)},p:z,i:z,o:z,d(t){t&&y(e)}}}function Yt(o){let e,t;return e=new Ve({props:{state:o[0],path:o[3].concat(o[10].path),schema:o[10]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&1&&(a.state=n[0]),i&8&&(a.path=n[3].concat(n[10].path)),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Kt(o){let e,t;return e=new Ve({props:{state:o[0],path:o[10].path,schema:o[10]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&1&&(a.state=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Rs(o){let e,t,n,i;const a=[As,Cs,$s,xs],s=[];function l(r,h){return r[1]===void 0?0:r[1].length===0?1:r[2]?2:3}return e=l(o),t=s[e]=a[e](o),{c(){t.c(),n=ie()},m(r,h){s[e].m(r,h),b(r,n,h),i=!0},p(r,[h]){let d=e;e=l(r),e===d?s[e].p(r,h):(G(),m(s[d],1,1,()=>{s[d]=null}),Y(),t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n))},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){s[e].d(r),r&&y(n)}}}function Ss(o,e,t){let n,{$$slots:i={},$$scope:a}=e,{state:s}=e,{configs:l}=e,{title:r=void 0}=e,{path:h=[]}=e,d=s.expertMode;te(o,d,f=>t(8,n=f));let p=l.filter(f=>{var w;return((w=f.hints)==null?void 0:w.group)!=="hidden"}),c=n?p:p.filter(f=>{var w;return((w=f.hints)==null?void 0:w.group)!=="expert"});return o.$$set=f=>{"state"in f&&t(0,s=f.state),"configs"in f&&t(1,l=f.configs),"title"in f&&t(2,r=f.title),"path"in f&&t(3,h=f.path),"$$scope"in f&&t(6,a=f.$$scope)},[s,l,r,h,d,c,a,i]}class me extends ae{constructor(e){super(),re(this,e,Ss,Rs,le,{state:0,configs:1,title:2,path:3})}}function Zt(o){let e,t,n,i,a;return t=new ft({props:{class:"h-6 w-6"}}),{c(){e=v("span"),x(t.$$.fragment),n=A(),i=O(o[0]),_(e,"class","alert flex w-min")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),g(e,i),a=!0},p(s,l){(!a||l&1)&&X(i,s[0])},i(s){a||(u(t.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),a=!1},d(s){s&&y(e),C(t)}}}function Is(o){let e,t,n=o[0]>0&&Zt(o);return{c(){n&&n.c(),e=ie()},m(i,a){n&&n.m(i,a),b(i,e,a),t=!0},p(i,[a]){i[0]>0?n?(n.p(i,a),a&1&&u(n,1)):(n=Zt(i),n.c(),u(n,1),n.m(e.parentNode,e)):n&&(G(),m(n,1,1,()=>{n=null}),Y())},i(i){t||(u(n),t=!0)},o(i){m(n),t=!1},d(i){n&&n.d(i),i&&y(e)}}}function js(o,e,t){let n,{firstPaths:i}=e,{state:a}=e,s=a.messages.map(l=>l.filter(r=>{const h=r.context.path;return i.has(h[0])||h.length>1&&i.has(h[1])}).length);return te(o,s,l=>t(0,n=l)),o.$$set=l=>{"firstPaths"in l&&t(2,i=l.firstPaths),"state"in l&&t(3,a=l.state)},[n,s,i,a]}class Qe extends ae{constructor(e){super(),re(this,e,js,Is,le,{firstPaths:2,state:3})}}const Js=o=>({}),Xt=o=>({});function Ws(o){var p;let e,t,n,i,a,s;function l(c,f){return f&8&&(t=null),t==null&&(t=Object.keys(c[3]).length>0),t?Ds:Os}let r=l(o,-1),h=r(o);i=new ze({props:{src:(p=o[5])==null?void 0:p.asHumanString(!1,!1,o[6])}});let d=o[7].length>0&&en(o);return{c(){e=v("div"),h.c(),n=A(),x(i.$$.fragment),a=A(),d&&d.c()},m(c,f){b(c,e,f),h.m(e,null),g(e,n),$(i,e,null),g(e,a),d&&d.m(e,null),s=!0},p(c,f){var k;r===(r=l(c,f))&&h?h.p(c,f):(h.d(1),h=r(c),h&&(h.c(),h.m(e,n)));const w={};f&96&&(w.src=(k=c[5])==null?void 0:k.asHumanString(!1,!1,c[6])),i.$set(w),c[7].length>0?d?(d.p(c,f),f&128&&u(d,1)):(d=en(c),d.c(),u(d,1),d.m(e,null)):d&&(G(),m(d,1,1,()=>{d=null}),Y())},i(c){s||(u(i.$$.fragment,c),u(d),s=!0)},o(c){m(i.$$.fragment,c),m(d),s=!1},d(c){c&&y(e),h.d(),C(i),d&&d.d()}}}function Ms(o){let e,t,n,i,a;n=new me({props:{state:o[0],configs:o[13],path:o[1]}});const s=o[15].delete,l=be(s,o,o[14],Xt);return{c(){e=v("div"),t=v("div"),x(n.$$.fragment),i=A(),l&&l.c(),_(t,"class","flex w-full flex-col"),_(e,"class","flex w-full items-start justify-between")},m(r,h){b(r,e,h),g(e,t),$(n,t,null),g(e,i),l&&l.m(e,null),a=!0},p(r,h){const d={};h&1&&(d.state=r[0]),h&2&&(d.path=r[1]),n.$set(d),l&&l.p&&(!a||h&16384)&&ye(l,s,r,r[14],a?ve(s,r[14],h,Js):we(r[14]),Xt)},i(r){a||(u(n.$$.fragment,r),u(l,r),a=!0)},o(r){m(n.$$.fragment,r),m(l,r),a=!1},d(r){r&&y(e),C(n),l&&l.d(r)}}}function Os(o){let e;return{c(){e=v("i"),e.textContent="No then is set"},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function Ds(o){let e,t;return{c(){e=v("b"),t=O(o[4])},m(n,i){b(n,e,i),g(e,t)},p(n,i){i&16&&X(t,n[4])},d(n){n&&y(e)}}}function en(o){let e,t,n,i=o[7].length+"",a,s,l;return t=new Ai({props:{class:"h-6 w-6"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),a=O(i),s=O(" errors"),_(e,"class","alert m-2 flex")},m(r,h){b(r,e,h),$(t,e,null),g(e,n),g(e,a),g(e,s),l=!0},p(r,h){(!l||h&128)&&i!==(i=r[7].length+"")&&X(a,i)},i(r){l||(u(t.$$.fragment,r),l=!0)},o(r){m(t.$$.fragment,r),l=!1},d(r){r&&y(e),C(t)}}}function Ns(o){let e,t,n,i,a,s,l,r,h;t=new yo({props:{class:"h-6 w-6"}});const d=[Ms,Ws],p=[];function c(f,w){return f[2]?0:1}return i=c(o),a=p[i]=d[i](o),{c(){e=v("button"),x(t.$$.fragment),n=A(),a.c(),s=ie()},m(f,w){b(f,e,w),$(t,e,null),b(f,n,w),p[i].m(f,w),b(f,s,w),l=!0,r||(h=Z(e,"click",o[16]),r=!0)},p(f,[w]){let k=i;i=c(f),i===k?p[i].p(f,w):(G(),m(p[k],1,1,()=>{p[k]=null}),Y(),a=p[i],a?a.p(f,w):(a=p[i]=d[i](f),a.c()),u(a,1),a.m(s.parentNode,s))},i(f){l||(u(t.$$.fragment,f),u(a),l=!0)},o(f){m(t.$$.fragment,f),m(a),l=!1},d(f){f&&y(e),C(t),f&&y(n),p[i].d(f),f&&y(s),r=!1,h()}}}function Fs(o,e,t){var S;let n,i,a,s,l,{$$slots:r={},$$scope:h}=e,{state:d}=e,{path:p}=e,c=d.messagesFor(p);te(o,c,q=>t(7,l=q));let w=d.getStoreFor([...p,"if"]).map(q=>q?Wn.Tag(q):void 0);te(o,w,q=>t(5,a=q));let k=w.map(q=>{if(!q)return{};const I=q.usedKeys(),M={};for(const J of I)M[J]="value";return M});te(o,k,q=>t(6,s=q));let T=d.getStoreFor([...p,"then"]);te(o,T,q=>t(3,n=q));let L=T.mapD(q=>typeof q=="string"?q:q.en);te(o,L,q=>t(4,i=q));let N=((S=Object.keys(n??{}))==null?void 0:S.length)===0,D=Ke.filter(q=>q.path[0]==="mappings").map(q=>ke.Clone(q)).map(q=>(q.path.splice(0,1),q)).filter(q=>q.path.length==1&&q.hints.group!=="hidden");const R=()=>{t(2,N=!N)};return o.$$set=q=>{"state"in q&&t(0,d=q.state),"path"in q&&t(1,p=q.path),"$$scope"in q&&t(14,h=q.$$scope)},[d,p,N,n,i,a,s,l,c,w,k,T,L,D,h,r,R]}class Ls extends ae{constructor(e){super(),re(this,e,Fs,Ns,le,{state:0,path:1})}}function tn(o,e,t){const n=o.slice();return n[28]=e[t],n}function nn(o,e,t){const n=o.slice();return n[31]=e[t],n[33]=t,n}const Es=o=>({}),on=o=>({}),Ps=o=>({}),sn=o=>({});function Hs(o){let e,t,n,i,a=[],s=new Map,l,r,h,d,p,c,f,w,k,T,L,N,D,R,S,q,I,M,J,E,W;const j=o[16]["upper-right"],F=be(j,o,o[20],on);let V=o[4]&&an(o),B=o[6]??[];const H=P=>P[31];for(let P=0;P<B.length;P+=1){let U=nn(o,B,P),pe=H(U);s.set(pe,a[P]=rn(pe,U))}let ee=o[4]&&ln(o);w=new xe({props:{state:o[0],path:[...o[1],"render"],schema:o[2].render}}),T=new me({props:{state:o[0],path:o[1],configs:o[14]}}),N=new xe({props:{state:o[0],path:[...o[1],"icon"],schema:o[2].icon}}),R=new xe({props:{state:o[0],path:[...o[1],"condition"],schema:o[2].condition}});let K=o[3]&&hn(o),se=o[15],oe=[];for(let P=0;P<se.length;P+=1)oe[P]=dn(tn(o,se,P));const Se=P=>m(oe[P],1,1,()=>{oe[P]=null});return M=new qe({props:{clss:"small mt-8",$$slots:{default:[zs]},$$scope:{ctx:o}}}),M.$on("click",o[19]),{c(){e=v("div"),t=v("div"),F&&F.c(),n=A(),V&&V.c(),i=A();for(let P=0;P<a.length;P+=1)a[P].c();l=A(),r=v("button"),r.textContent="Add a predefined option",h=A(),ee&&ee.c(),d=A(),p=v("h3"),p.textContent="Text field and input element configuration",c=A(),f=v("div"),x(w.$$.fragment),k=A(),x(T.$$.fragment),L=A(),x(N.$$.fragment),D=A(),x(R.$$.fragment),S=A(),K&&K.c(),q=A();for(let P=0;P<oe.length;P+=1)oe[P].c();I=A(),x(M.$$.fragment),_(t,"class","flex justify-end"),_(r,"class","primary"),_(f,"class","border-l border-dashed border-gray-800 pl-2"),_(e,"class","flex w-full flex-col gap-y-1 p-1 pr-12")},m(P,U){b(P,e,U),g(e,t),F&&F.m(t,null),g(e,n),V&&V.m(e,null),g(e,i);for(let pe=0;pe<a.length;pe+=1)a[pe]&&a[pe].m(e,null);g(e,l),g(e,r),g(e,h),ee&&ee.m(e,null),g(e,d),g(e,p),g(e,c),g(e,f),$(w,f,null),g(f,k),$(T,f,null),g(f,L),$(N,f,null),g(e,D),$(R,e,null),g(e,S),K&&K.m(e,null),g(e,q);for(let pe=0;pe<oe.length;pe+=1)oe[pe]&&oe[pe].m(e,null);g(e,I),$(M,e,null),J=!0,E||(W=Z(r,"click",o[18]),E=!0)},p(P,U){F&&F.p&&(!J||U[0]&1048576)&&ye(F,j,P,P[20],J?ve(j,P[20],U,Es):we(P[20]),on),P[4]?V?(V.p(P,U),U[0]&16&&u(V,1)):(V=an(P),V.c(),u(V,1),V.m(e,i)):V&&(G(),m(V,1,1,()=>{V=null}),Y()),U[0]&12355&&(B=P[6]??[],G(),a=qi(a,U,H,1,P,B,s,e,ki,rn,l,nn),Y()),P[4]?ee?(ee.p(P,U),U[0]&16&&u(ee,1)):(ee=ln(P),ee.c(),u(ee,1),ee.m(e,d)):ee&&(G(),m(ee,1,1,()=>{ee=null}),Y());const pe={};U[0]&1&&(pe.state=P[0]),U[0]&2&&(pe.path=[...P[1],"render"]),U[0]&4&&(pe.schema=P[2].render),w.$set(pe);const ce={};U[0]&1&&(ce.state=P[0]),U[0]&2&&(ce.path=P[1]),T.$set(ce);const We={};U[0]&1&&(We.state=P[0]),U[0]&2&&(We.path=[...P[1],"icon"]),U[0]&4&&(We.schema=P[2].icon),N.$set(We);const Te={};if(U[0]&1&&(Te.state=P[0]),U[0]&2&&(Te.path=[...P[1],"condition"]),U[0]&4&&(Te.schema=P[2].condition),R.$set(Te),P[3]?K?(K.p(P,U),U[0]&8&&u(K,1)):(K=hn(P),K.c(),u(K,1),K.m(e,q)):K&&(G(),m(K,1,1,()=>{K=null}),Y()),U[0]&32775){se=P[15];let fe;for(fe=0;fe<se.length;fe+=1){const Re=tn(P,se,fe);oe[fe]?(oe[fe].p(Re,U),u(oe[fe],1)):(oe[fe]=dn(Re),oe[fe].c(),u(oe[fe],1),oe[fe].m(e,I))}for(G(),fe=se.length;fe<oe.length;fe+=1)Se(fe);Y()}const Ie={};U[0]&1048576&&(Ie.$$scope={dirty:U,ctx:P}),M.$set(Ie)},i(P){if(!J){u(F,P),u(V);for(let U=0;U<B.length;U+=1)u(a[U]);u(ee),u(w.$$.fragment,P),u(T.$$.fragment,P),u(N.$$.fragment,P),u(R.$$.fragment,P),u(K);for(let U=0;U<se.length;U+=1)u(oe[U]);u(M.$$.fragment,P),J=!0}},o(P){m(F,P),m(V);for(let U=0;U<a.length;U+=1)m(a[U]);m(ee),m(w.$$.fragment,P),m(T.$$.fragment,P),m(N.$$.fragment,P),m(R.$$.fragment,P),m(K),oe=oe.filter(Boolean);for(let U=0;U<oe.length;U+=1)m(oe[U]);m(M.$$.fragment,P),J=!1},d(P){P&&y(e),F&&F.d(P),V&&V.d();for(let U=0;U<a.length;U+=1)a[U].d();ee&&ee.d(),C(w),C(T),C(N),C(R),K&&K.d(),ue(oe,P),C(M),E=!1,W()}}}function Bs(o){let e,t,n,i;t=new Be({props:{config:o[10],selectedElement:void 0,state:o[0],tags:o[11]}});const a=o[16]["upper-right"],s=be(a,o,o[20],sn);return{c(){e=v("div"),x(t.$$.fragment),n=A(),s&&s.c(),_(e,"class","low-interaction flex")},m(l,r){b(l,e,r),$(t,e,null),g(e,n),s&&s.m(e,null),i=!0},p(l,r){const h={};r[0]&1&&(h.state=l[0]),t.$set(h),s&&s.p&&(!i||r[0]&1048576)&&ye(s,a,l,l[20],i?ve(a,l[20],r,Ps):we(l[20]),sn)},i(l){i||(u(t.$$.fragment,l),u(s,l),i=!0)},o(l){m(t.$$.fragment,l),m(s,l),i=!1},d(l){l&&y(e),C(t),s&&s.d(l)}}}function an(o){let e,t,n,i;return e=new xe({props:{startInEditModeIfUnset:!0,state:o[0],path:[...o[1],"question"],schema:o[2].question}}),n=new xe({props:{state:o[0],path:[...o[1],"questionHint"],schema:o[2].questionHint}}),{c(){x(e.$$.fragment),t=A(),x(n.$$.fragment)},m(a,s){$(e,a,s),b(a,t,s),$(n,a,s),i=!0},p(a,s){const l={};s[0]&1&&(l.state=a[0]),s[0]&2&&(l.path=[...a[1],"question"]),s[0]&4&&(l.schema=a[2].question),e.$set(l);const r={};s[0]&1&&(r.state=a[0]),s[0]&2&&(r.path=[...a[1],"questionHint"]),s[0]&4&&(r.schema=a[2].questionHint),n.$set(r)},i(a){i||(u(e.$$.fragment,a),u(n.$$.fragment,a),i=!0)},o(a){m(e.$$.fragment,a),m(n.$$.fragment,a),i=!1},d(a){C(e,a),a&&y(t),C(n,a)}}}function Us(o){let e,t,n,i,a;t=new _o({props:{class:"h-4 w-4"}});function s(){return o[17](o[33])}return{c(){e=v("button"),x(t.$$.fragment),_(e,"slot","delete"),_(e,"class","no-image-background rounded-full")},m(l,r){b(l,e,r),$(t,e,null),n=!0,i||(a=Z(e,"click",s),i=!0)},p(l,r){o=l},i(l){n||(u(t.$$.fragment,l),n=!0)},o(l){m(t.$$.fragment,l),n=!1},d(l){l&&y(e),C(t),i=!1,a()}}}function rn(o,e){let t,n,i;return n=new Ls({props:{state:e[0],path:[...e[1],"mappings",e[33]],$$slots:{delete:[Us]},$$scope:{ctx:e}}}),{key:o,first:null,c(){t=v("div"),x(n.$$.fragment),_(t,"class","interactive flex w-full"),this.first=t},m(a,s){b(a,t,s),$(n,t,null),i=!0},p(a,s){e=a;const l={};s[0]&1&&(l.state=e[0]),s[0]&66&&(l.path=[...e[1],"mappings",e[33]]),s[0]&1048640&&(l.$$scope={dirty:s,ctx:e}),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(t),C(n)}}}function ln(o){let e,t;return e=new xe({props:{state:o[0],path:[...o[1],"multiAnswer"],schema:o[2].multiAnswer}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&1&&(a.state=n[0]),i[0]&2&&(a.path=[...n[1],"multiAnswer"]),i[0]&4&&(a.schema=n[2].multiAnswer),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function hn(o){let e,t;return e=new xe({props:{state:o[0],path:[...o[1],"metacondition"],schema:o[2].metacondition}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&1&&(a.state=n[0]),i[0]&2&&(a.path=[...n[1],"metacondition"]),i[0]&4&&(a.schema=n[2].metacondition),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function dn(o){let e,t;return e=new xe({props:{state:o[0],path:[...o[1],o[28]],schema:o[2][o[28]]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&1&&(a.state=n[0]),i[0]&2&&(a.path=[...n[1],n[28]]),i[0]&4&&(a.schema=n[2][n[28]]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function zs(o){let e,t,n;return e=new to({props:{class:"h-6 w-6"}}),{c(){x(e.$$.fragment),t=O(`
      Show the introduction again`)},m(i,a){$(e,i,a),b(i,t,a),n=!0},p:z,i(i){n||(u(e.$$.fragment,i),n=!0)},o(i){m(e.$$.fragment,i),n=!1},d(i){C(e,i),i&&y(t)}}}function Vs(o){let e,t,n,i;const a=[Bs,Hs],s=[];function l(r,h){return typeof r[5]=="string"?0:1}return e=l(o),t=s[e]=a[e](o),{c(){t.c(),n=ie()},m(r,h){s[e].m(r,h),b(r,n,h),i=!0},p(r,h){let d=e;e=l(r),e===d?s[e].p(r,h):(G(),m(s[d],1,1,()=>{s[d]=null}),Y(),t=s[e],t?t.p(r,h):(t=s[e]=a[e](r),t.c()),u(t,1),t.m(n.parentNode,n))},i(r){i||(u(t),i=!0)},o(r){m(t),i=!1},d(r){s[e].d(r),r&&y(n)}}}function Qs(o,e,t){let n,i,a,s,{$$slots:l={},$$scope:r}=e,{state:h}=e,{path:d}=e,p=h.expertMode;te(o,p,B=>t(3,n=B));const c=h.getStoreFor(d);te(o,c,B=>t(5,a=B));let f=c.data,w=_e.asBoolean(Nn.Get("studio-seen-tagrendering-tutorial","false"));lt(()=>{w.data||(h.showIntro.setData("tagrenderings"),w.setData(!0))});let k=h.configuration.mapD(B=>{var H;return d.at(0)==="tagRenderings"&&((H=B.source)==null?void 0:H.geoJson)===void 0});te(o,k,B=>t(4,i=B));let T=[],L={};for(const B of Dn){let H=B.description??B.question??"No description available";if(H=H.en??H,B.labels){const ee=B.labels;for(const K of ee){let se=L[K];se||(se={if:"value="+K,then:{en:"Builtin collection <b>"+K+"</b>:"}},L[K]=se,T.push(se)),se.then.en=se.then.en+"<div>"+H+"</div>"}}T.push({if:"value="+B.id,then:{en:"Builtin <b>"+B.id+"</b> <div class='subtle'>"+H+"</div>"}})}const N=new Ue({question:"Which builtin element should be shown?",mappings:T}),D=new _e({value:f});D.addCallbackAndRunD(B=>{c.setData(B.value)});let R=h.getStoreFor([...d,"mappings"]);te(o,R,B=>t(6,s=B));const S={};for(const B of Ke)B.path.length===1&&(S[B.path[0]]=B);function q(){R.data===void 0&&R.setData([])}const I=new Set(["question","questionHint","multiAnswer","freeform","render","condition","metacondition","mappings","icon"]),M=new Set(["labels","description","classes"]),J=Ke.filter(B=>B.path.length==2&&B.path[0]==="freeform"&&i);let E=n?J:J.filter(B=>{var H;return((H=B.hints)==null?void 0:H.group)!=="expert"});const W=Ke.filter(B=>B.path.length>=1&&!I.has(B.path[0])&&!M.has(B.path[0])).map(B=>B.path.join("."));console.log({state:h});const j=B=>{q(),R.data.splice(B,1),R.ping()},F=()=>{q(),R.data.push({if:void 0,then:{}}),R.ping()},V=()=>h.showIntro.setData("tagrenderings");return o.$$set=B=>{"state"in B&&t(0,h=B.state),"path"in B&&t(1,d=B.path),"$$scope"in B&&t(20,r=B.$$scope)},[h,d,S,n,i,a,s,p,c,k,N,D,R,q,E,W,l,j,F,V,r]}class Gs extends ae{constructor(e){super(),re(this,e,Qs,Vs,le,{state:0,path:1},null,[-1,-1])}}function pn(o,e,t){const n=o.slice();return n[1]=e[t],n}function cn(o){let e;return{c(){e=v("div"),e.textContent="No errors, warnings or messages",_(e,"class","thanks")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function fn(o){let e,t=o[1].level+"",n,i,a,s=o[1].context.path.join(".")+"",l,r,h=o[1].message+"",d,p,c,f=o[1].context.operation.join(".")+"",w,k;return{c(){e=v("li"),n=O(t),i=A(),a=v("span"),l=O(s),r=A(),d=O(h),p=A(),c=v("span"),w=O(f),k=A(),_(a,"class","literal-code"),_(c,"class","literal-code")},m(T,L){b(T,e,L),g(e,n),g(e,i),g(e,a),g(a,l),g(e,r),g(e,d),g(e,p),g(e,c),g(c,w),g(e,k)},p(T,L){L&1&&t!==(t=T[1].level+"")&&X(n,t),L&1&&s!==(s=T[1].context.path.join(".")+"")&&X(l,s),L&1&&h!==(h=T[1].message+"")&&X(d,h),L&1&&f!==(f=T[1].context.operation.join(".")+"")&&X(w,f)},d(T){T&&y(e)}}}function Ys(o){let e,t,n=o[0].length===0&&cn(),i=o[0],a=[];for(let s=0;s<i.length;s+=1)a[s]=fn(pn(o,i,s));return{c(){n&&n.c(),e=A();for(let s=0;s<a.length;s+=1)a[s].c();t=ie()},m(s,l){n&&n.m(s,l),b(s,e,l);for(let r=0;r<a.length;r+=1)a[r]&&a[r].m(s,l);b(s,t,l)},p(s,[l]){if(s[0].length===0?n||(n=cn(),n.c(),n.m(e.parentNode,e)):n&&(n.d(1),n=null),l&1){i=s[0];let r;for(r=0;r<i.length;r+=1){const h=pn(s,i,r);a[r]?a[r].p(h,l):(a[r]=fn(h),a[r].c(),a[r].m(t.parentNode,t))}for(;r<a.length;r+=1)a[r].d(1);a.length=i.length}},i:z,o:z,d(s){n&&n.d(s),s&&y(e),ue(a,s),s&&y(t)}}}function Ks(o,e,t){let{messages:n}=e;return o.$$set=i=>{"messages"in i&&t(0,n=i.messages)},[n]}class zn extends ae{constructor(e){super(),re(this,e,Ks,Ys,le,{messages:0})}}function Zs(o,e,t){return e in o?Object.defineProperty(o,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):o[e]=t,o}function un(o,e){var t=Object.keys(o);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(o);e&&(n=n.filter(function(i){return Object.getOwnPropertyDescriptor(o,i).enumerable})),t.push.apply(t,n)}return t}function gn(o){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?un(Object(t),!0).forEach(function(n){Zs(o,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(t)):un(Object(t)).forEach(function(n){Object.defineProperty(o,n,Object.getOwnPropertyDescriptor(t,n))})}return o}function Xs(o,e){if(o==null)return{};var t={},n=Object.keys(o),i,a;for(a=0;a<n.length;a++)i=n[a],!(e.indexOf(i)>=0)&&(t[i]=o[i]);return t}function ea(o,e){if(o==null)return{};var t=Xs(o,e),n,i;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(o);for(i=0;i<a.length;i++)n=a[i],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(o,n)&&(t[n]=o[n])}return t}function ta(o,e){return na(o)||ia(o,e)||oa(o,e)||sa()}function na(o){if(Array.isArray(o))return o}function ia(o,e){if(!(typeof Symbol>"u"||!(Symbol.iterator in Object(o)))){var t=[],n=!0,i=!1,a=void 0;try{for(var s=o[Symbol.iterator](),l;!(n=(l=s.next()).done)&&(t.push(l.value),!(e&&t.length===e));n=!0);}catch(r){i=!0,a=r}finally{try{!n&&s.return!=null&&s.return()}finally{if(i)throw a}}return t}}function oa(o,e){if(o){if(typeof o=="string")return mn(o,e);var t=Object.prototype.toString.call(o).slice(8,-1);if(t==="Object"&&o.constructor&&(t=o.constructor.name),t==="Map"||t==="Set")return Array.from(o);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return mn(o,e)}}function mn(o,e){(e==null||e>o.length)&&(e=o.length);for(var t=0,n=new Array(e);t<e;t++)n[t]=o[t];return n}function sa(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function aa(o,e,t){return e in o?Object.defineProperty(o,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):o[e]=t,o}function bn(o,e){var t=Object.keys(o);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(o);e&&(n=n.filter(function(i){return Object.getOwnPropertyDescriptor(o,i).enumerable})),t.push.apply(t,n)}return t}function yn(o){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?bn(Object(t),!0).forEach(function(n){aa(o,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(o,Object.getOwnPropertyDescriptors(t)):bn(Object(t)).forEach(function(n){Object.defineProperty(o,n,Object.getOwnPropertyDescriptor(t,n))})}return o}function ra(){for(var o=arguments.length,e=new Array(o),t=0;t<o;t++)e[t]=arguments[t];return function(n){return e.reduceRight(function(i,a){return a(i)},n)}}function Fe(o){return function e(){for(var t=this,n=arguments.length,i=new Array(n),a=0;a<n;a++)i[a]=arguments[a];return i.length>=o.length?o.apply(this,i):function(){for(var s=arguments.length,l=new Array(s),r=0;r<s;r++)l[r]=arguments[r];return e.apply(t,[].concat(i,l))}}}function tt(o){return{}.toString.call(o).includes("Object")}function la(o){return!Object.keys(o).length}function Ee(o){return typeof o=="function"}function ha(o,e){return Object.prototype.hasOwnProperty.call(o,e)}function da(o,e){return tt(e)||je("changeType"),Object.keys(e).some(function(t){return!ha(o,t)})&&je("changeField"),e}function pa(o){Ee(o)||je("selectorType")}function ca(o){Ee(o)||tt(o)||je("handlerType"),tt(o)&&Object.values(o).some(function(e){return!Ee(e)})&&je("handlersType")}function fa(o){o||je("initialIsRequired"),tt(o)||je("initialType"),la(o)&&je("initialContent")}function ua(o,e){throw new Error(o[e]||o.default)}var ga={initialIsRequired:"initial state is required",initialType:"initial state should be an object",initialContent:"initial state shouldn't be an empty object",handlerType:"handler should be an object or a function",handlersType:"all handlers should be a functions",selectorType:"selector should be a function",changeType:"provided value of changes should be an object",changeField:'it seams you want to change a field in the state which is not specified in the "initial" state',default:"an unknown error accured in `state-local` package"},je=Fe(ua)(ga),Ye={changes:da,selector:pa,handler:ca,initial:fa};function ma(o){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};Ye.initial(o),Ye.handler(e);var t={current:o},n=Fe(wa)(t,e),i=Fe(ya)(t),a=Fe(Ye.changes)(o),s=Fe(ba)(t);function l(){var h=arguments.length>0&&arguments[0]!==void 0?arguments[0]:function(d){return d};return Ye.selector(h),h(t.current)}function r(h){ra(n,i,a,s)(h)}return[l,r]}function ba(o,e){return Ee(e)?e(o.current):e}function ya(o,e){return o.current=yn(yn({},o.current),e),e}function wa(o,e,t){return Ee(e)?e(o.current):Object.keys(t).forEach(function(n){var i;return(i=e[n])===null||i===void 0?void 0:i.call(e,o.current[n])}),t}var va={create:ma},_a={paths:{vs:"https://cdn.jsdelivr.net/npm/monaco-editor@0.43.0/min/vs"}};function Ta(o){return function e(){for(var t=this,n=arguments.length,i=new Array(n),a=0;a<n;a++)i[a]=arguments[a];return i.length>=o.length?o.apply(this,i):function(){for(var s=arguments.length,l=new Array(s),r=0;r<s;r++)l[r]=arguments[r];return e.apply(t,[].concat(i,l))}}}function qa(o){return{}.toString.call(o).includes("Object")}function ka(o){return o||wn("configIsRequired"),qa(o)||wn("configType"),o.urls?(xa(),{paths:{vs:o.urls.monacoBase}}):o}function xa(){console.warn(Vn.deprecation)}function $a(o,e){throw new Error(o[e]||o.default)}var Vn={configIsRequired:"the configuration object is required",configType:"the configuration object should be an object",default:"an unknown error accured in `@monaco-editor/loader` package",deprecation:`Deprecation warning!
  ...
  `},wn=Ta($a)(Vn),Ca={config:ka},Aa=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];return function(i){return t.reduceRight(function(a,s){return s(a)},i)}};function Qn(o,e){return Object.keys(e).forEach(function(t){e[t]instanceof Object&&o[t]&&Object.assign(e[t],Qn(o[t],e[t]))}),gn(gn({},o),e)}var Ra={type:"cancelation",msg:"operation is manually canceled"};function at(o){var e=!1,t=new Promise(function(n,i){o.then(function(a){return e?i(Ra):n(a)}),o.catch(i)});return t.cancel=function(){return e=!0},t}var Sa=va.create({config:_a,isInitialized:!1,resolve:null,reject:null,monaco:null}),Gn=ta(Sa,2),Ge=Gn[0],st=Gn[1];function Ia(o){var e=Ca.config(o),t=e.monaco,n=ea(e,["monaco"]);st(function(i){return{config:Qn(i.config,n),monaco:t}})}function ja(){var o=Ge(function(e){var t=e.monaco,n=e.isInitialized,i=e.resolve;return{monaco:t,isInitialized:n,resolve:i}});if(!o.isInitialized){if(st({isInitialized:!0}),o.monaco)return o.resolve(o.monaco),at(rt);if(window.monaco&&window.monaco.editor)return Yn(window.monaco),o.resolve(window.monaco),at(rt);Aa(Ja,Ma)(Oa)}return at(rt)}function Ja(o){return document.body.appendChild(o)}function Wa(o){var e=document.createElement("script");return o&&(e.src=o),e}function Ma(o){var e=Ge(function(n){var i=n.config,a=n.reject;return{config:i,reject:a}}),t=Wa("".concat(e.config.paths.vs,"/loader.js"));return t.onload=function(){return o()},t.onerror=e.reject,t}function Oa(){var o=Ge(function(t){var n=t.config,i=t.resolve,a=t.reject;return{config:n,resolve:i,reject:a}}),e=window.require;e.config(o.config),e(["vs/editor/editor.main"],function(t){Yn(t),o.resolve(t)},function(t){o.reject(t)})}function Yn(o){Ge().monaco||st({monaco:o})}function Da(){return Ge(function(o){var e=o.monaco;return e})}var rt=new Promise(function(o,e){return st({resolve:o,reject:e})}),vn={config:Ia,init:ja,__getMonacoInstance:Da};const Na="Configuration for a single layer",Fa="object",La={id:{description:`question: What is the identifier of this layer?
...
group: hidden`,type:"boolean"}},Ea=["id","pointRendering","source"],Pa={TagConfigJson:{description:`The main representation of Tags.
See https://github.com/pietervdvn/MapComplete/blob/develop/Docs/Tags_format.md for more documentation
...
When a default input method should be used, this can be specified by setting the canonical denomination here, e.g.
\`defaultInput: "cm"\`. This must be a denomination which appears in the applicableUnits`,type:"string"}},required:["applicableUnits"],additionalProperties:!1},"Record<string,string|{quantity:string;denominations:string[];canonical?:string|undefined;}>":{type:"object",additionalProperties:!1}},Ha="http://json-schema.org/draft-07/schema#",Ba=!1,Ua={description:Na,type:Fa,properties:La,required:Ea,definitions:Pa,$schema:Ha,additionalProperties:Ba},za=`Defines the entire theme.
...
General remark: a type (string | any) indicates either a fixed or a translatable string.`,Va="object",Qa={id:{description:`question: What is the id of this layout?
...
group: hidden`,type:"boolean"}},Ga=["description","icon","id","layers","title"],Ya={TagConfigJson:{description:`The main representation of Tags.
See https://github.com/pietervdvn/MapComplete/blob/develop/Docs/Tags_format.md for more documentation
...
group: hidden`,type:"boolean"}},additionalProperties:!1},"Partial<any>":{type:"object",additionalProperties:!1},RasterLayerProperties:{description:"This class has grown beyond the point of only containing Raster Layers",type:"object",properties:{name:{description:"The name of the imagery source",anyOf:[{$ref:"#/definitions/Record<string,string>"},{type:"string"}]},isOverlay:{type:"boolean"},id:{type:"string"},url:{type:"string"},category:{type:"string"},type:{type:"string"},style:{type:"string"},attribution:{type:"object",properties:{url:{type:"string"},text:{type:"string"},html:{type:"string"},required:{type:"boolean"}}},min_zoom:{type:"number"},max_zoom:{type:"number"},best:{type:"boolean"}},required:["id","name","url"],additionalProperties:!1}},Ka="http://json-schema.org/draft-07/schema#",Za=!1,Xa={description:za,type:Va,properties:Qa,required:Ga,definitions:Ya,$schema:Ka,additionalProperties:Za};function er(o){let e;return{c(){e=v("div"),_(e,"class","h-full w-full")},m(t,n){b(t,e,n),o[2](e)},p:z,i:z,o:z,d(t){t&&y(e),o[2](null)}}}function tr(o,e,t){let{state:n}=e,i,a,s,l;function r(){try{const d=JSON.parse(s.getValue());n.configuration.setData(d)}catch(d){console.error(d)}}lt(()=>{const d=p=>{p.key==="s"&&(p.ctrlKey||p.metaKey)&&(p.preventDefault(),r())};return window.addEventListener("keydown",d),()=>window.removeEventListener("keydown",d)}),lt(async()=>{const d=await Ri(()=>import("./editor.main-13febf1b.js").then(w=>w.e),["./editor.main-13febf1b.js","./preload-helper-03312bcc.js","./index-047bb07b.js","./Utils-28f00dfc.js","./tw-merge-7570a3e9.js","./UIEventSource-2fd3b430.js","./LocalStorageSource-91540725.js","./FixImages-4ab5f783.js","./Constants-6798f846.js","./placeholder-08a2b84e.js","./Loading-754de247.js","./OsmConnection-63d2895e.js","./LanguagePicker-e1c7ef89.js","./Dropdown-46c343d5.js","./Checkbox-8faab040.js","./BackButton-4febcf6d.js","./Add-f3431a17.js","./Login-be56b5c4.js","./preload-helper-d6f55416.css","./editor-a89423dd.css"],import.meta.url);vn.config({monaco:d.default}),a=await vn.init();let p;n instanceof En?p="https://mapcomplete.org/schemas/layerconfig.json":p="https://mapcomplete.org/schemas/layoutconfig.json",a.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,schemas:[{uri:p,fileMatch:["file.json"],schema:p==="https://mapcomplete.org/schemas/layerconfig.json"?Ua:Xa}]});let c=a.Uri.parse("inmemory://inmemory/file.json");l=a.editor.createModel(JSON.stringify(n.configuration.data,null,"  "),"json",c),s=a.editor.create(i,{model:l,automaticLayout:!0});let f;s.onDidChangeModelContent(()=>{clearTimeout(f),f=setTimeout(()=>{r()},500)})}),Xe(()=>{s&&s.dispose(),l&&l.dispose()});function h(d){xi[d?"unshift":"push"](()=>{i=d,t(0,i)})}return o.$$set=d=>{"state"in d&&t(1,n=d.state)},[i,n,h]}class Kn extends ae{constructor(e){super(),re(this,e,tr,er,le,{state:1})}}function nr(o){let e,t,n,i,a;return t=new De({props:{$$slots:{default:[or]},$$scope:{ctx:o}}}),t.$on("click",o[6]),i=new qe({props:{clss:"primary",$$slots:{default:[sr]},$$scope:{ctx:o}}}),i.$on("click",o[7]),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),_(e,"class","flex")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),$(i,e,null),a=!0},p(s,l){const r={};l&256&&(r.$$scope={dirty:l,ctx:s}),t.$set(r);const h={};l&257&&(h.$$scope={dirty:l,ctx:s}),i.$set(h)},i(s){a||(u(t.$$.fragment,s),u(i.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),m(i.$$.fragment,s),a=!1},d(s){s&&y(e),C(t),C(i)}}}function ir(o){let e,t,n,i,a,s,l;return t=new Sn({props:{class:"h-6 w-6"}}),{c(){e=v("button"),x(t.$$.fragment),n=O(`
      Delete this  `),i=O(o[0]),_(e,"class","small")},m(r,h){b(r,e,h),$(t,e,null),g(e,n),g(e,i),a=!0,s||(l=Z(e,"click",o[5]),s=!0)},p(r,h){(!a||h&1)&&X(i,r[0])},i(r){a||(u(t.$$.fragment,r),a=!0)},o(r){m(t.$$.fragment,r),a=!1},d(r){r&&y(e),C(t),s=!1,l()}}}function or(o){let e;return{c(){e=O("Don't delete")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function sr(o){let e,t,n,i,a;return t=new Sn({props:{class:"h-6 w-6"}}),{c(){e=v("div"),x(t.$$.fragment),n=O(`
          Do delete this `),i=O(o[0]),_(e,"class","alert flex p-2")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),g(e,i),a=!0},p(s,l){(!a||l&1)&&X(i,s[0])},i(s){a||(u(t.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),a=!1},d(s){s&&y(e),C(t)}}}function ar(o){let e,t,n,i;const a=[ir,nr],s=[];function l(r,h){return r[1]==="init"?0:r[1]==="confirm"?1:-1}return~(t=l(o))&&(n=s[t]=a[t](o)),{c(){e=v("div"),n&&n.c(),_(e,"class","mt-12")},m(r,h){b(r,e,h),~t&&s[t].m(e,null),i=!0},p(r,[h]){let d=t;t=l(r),t===d?~t&&s[t].p(r,h):(n&&(G(),m(s[d],1,1,()=>{s[d]=null}),Y()),~t?(n=s[t],n?n.p(r,h):(n=s[t]=a[t](r),n.c()),u(n,1),n.m(e,null)):n=null)},i(r){i||(u(n),i=!0)},o(r){m(n),i=!1},d(r){r&&y(e),~t&&s[t].d()}}}function rr(o,e,t){let n="init",{backToStudio:i}=e,{state:a}=e,{objectType:s}=e;function l(){a.delete(),i()}const r=()=>{t(1,n="confirm")},h=()=>{t(1,n="init")},d=()=>l();return o.$$set=p=>{"backToStudio"in p&&t(3,i=p.backToStudio),"state"in p&&t(4,a=p.state),"objectType"in p&&t(0,s=p.objectType)},[s,n,l,i,a,r,h,d]}class Zn extends ae{constructor(e){super(),re(this,e,rr,ar,le,{backToStudio:3,state:4,objectType:0})}}function _n(o,e,t){const n=o.slice();return n[24]=e[t],n}function lr(o){let e,t,n;return{c(){e=v("h3"),t=O("Editing layer "),n=O(o[3])},m(i,a){b(i,e,a),g(e,t),g(e,n)},p(i,a){a&8&&X(n,i[3])},d(i){i&&y(e)}}}function hr(o){let e;return{c(){e=v("h3"),e.textContent="Creating a new layer"},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function dr(o){let e,t,n,i,a,s,l,r,h,d,p,c;return a=new ht({props:{class:"h-6 w-6 shrink-0"}}),d=new ht({props:{class:"h-6 w-6 shrink-0"}}),{c(){e=v("div"),t=v("a"),n=v("div"),n.innerHTML=`<b>Test in safe mode</b> 
            <div>No changes are recoded to OSM</div>`,i=A(),x(a.$$.fragment),l=A(),r=v("a"),h=O(`Try it out
          `),x(d.$$.fragment),_(n,"class","flex flex-col"),_(t,"class","button small"),_(t,"href",s=o[11]+o[0].server.layerUrl(o[10].data)+"&test=true"),_(t,"target","_blank"),_(t,"rel","noopener"),_(r,"class","primary button"),_(r,"href",p=o[11]+o[0].server.layerUrl(o[10].data)),_(r,"target","_blank"),_(r,"rel","noopener"),_(e,"class","flex")},m(f,w){b(f,e,w),g(e,t),g(t,n),g(t,i),$(a,t,null),g(e,l),g(e,r),g(r,h),$(d,r,null),c=!0},p(f,w){(!c||w&1&&s!==(s=f[11]+f[0].server.layerUrl(f[10].data)+"&test=true"))&&_(t,"href",s),(!c||w&1&&p!==(p=f[11]+f[0].server.layerUrl(f[10].data)))&&_(r,"href",p)},i(f){c||(u(a.$$.fragment,f),u(d.$$.fragment,f),c=!0)},o(f){m(a.$$.fragment,f),m(d.$$.fragment,f),c=!1},d(f){f&&y(e),C(a),C(d)}}}function pr(o){let e,t,n;return{c(){e=v("div"),t=O(o[5]),n=O(" errors detected"),_(e,"class","alert")},m(i,a){b(i,e,a),g(e,t),g(e,n)},p(i,a){a&32&&X(t,i[5])},i:z,o:z,d(i){i&&y(e)}}}function cr(o){let e;return{c(){e=v("div"),_(e,"class","w-16")},m(t,n){b(t,e,n)},p:z,i:z,o:z,d(t){t&&y(e)}}}function fr(o){let e,t,n,i,a;t=new In({props:{$$slots:{content5:[$r],title5:[xr],content4:[kr],title4:[qr],content3:[Tr],title3:[_r],content2:[vr],title2:[wr],content1:[yr],title1:[br],content0:[mr],title0:[gr]},$$scope:{ctx:o}}});let s=o[7]!==void 0&&Tn(o);return{c(){e=v("div"),x(t.$$.fragment),n=A(),s&&s.c(),i=ie(),_(e,"class","m4 h-full overflow-y-auto")},m(l,r){b(l,e,r),$(t,e,null),b(l,n,r),s&&s.m(l,r),b(l,i,r),a=!0},p(l,r){const h={};r&524359&&(h.$$scope={dirty:r,ctx:l}),t.$set(h),l[7]!==void 0?s?(s.p(l,r),r&128&&u(s,1)):(s=Tn(l),s.c(),u(s,1),s.m(i.parentNode,i)):s&&(G(),m(s,1,1,()=>{s=null}),Y())},i(l){a||(u(t.$$.fragment,l),u(s),a=!0)},o(l){m(t.$$.fragment,l),m(s),a=!1},d(l){l&&y(e),C(t),l&&y(n),s&&s.d(l),l&&y(i)}}}function ur(o){let e,t,n=o[14],i=[];for(let s=0;s<n.length;s+=1)i[s]=qn(_n(o,n,s));const a=s=>m(i[s],1,1,()=>{i[s]=null});return{c(){for(let s=0;s<i.length;s+=1)i[s].c();e=ie()},m(s,l){for(let r=0;r<i.length;r+=1)i[r]&&i[r].m(s,l);b(s,e,l),t=!0},p(s,l){if(l&24577){n=s[14];let r;for(r=0;r<n.length;r+=1){const h=_n(s,n,r);i[r]?(i[r].p(h,l),u(i[r],1)):(i[r]=qn(h),i[r].c(),u(i[r],1),i[r].m(e.parentNode,e))}for(G(),r=n.length;r<i.length;r+=1)a(r);Y()}},i(s){if(!t){for(let l=0;l<n.length;l+=1)u(i[l]);t=!0}},o(s){i=i.filter(Boolean);for(let l=0;l<i.length;l+=1)m(i[l]);t=!1},d(s){ue(i,s),s&&y(e)}}}function gr(o){let e,t,n,i;return n=new Qe({props:{firstPaths:o[12]("Basic"),state:o[0]}}),{c(){e=v("div"),t=O(`General properties
          `),x(n.$$.fragment),_(e,"slot","title0"),_(e,"class","flex")},m(a,s){b(a,e,s),g(e,t),$(n,e,null),i=!0},p(a,s){const l={};s&1&&(l.state=a[0]),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(e),C(n)}}}function mr(o){let e,t,n,i,a;return t=new me({props:{state:o[0],configs:o[2].Basic}}),i=new Zn({props:{state:o[0],backToStudio:o[1],objectType:"layer"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),_(e,"class","flex flex-col mb-8"),_(e,"slot","content0")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),$(i,e,null),a=!0},p(s,l){const r={};l&1&&(r.state=s[0]),l&4&&(r.configs=s[2].Basic),t.$set(r);const h={};l&1&&(h.state=s[0]),l&2&&(h.backToStudio=s[1]),i.$set(h)},i(s){a||(u(t.$$.fragment,s),u(i.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),m(i.$$.fragment,s),a=!1},d(s){s&&y(e),C(t),C(i)}}}function br(o){let e,t,n,i;return n=new Qe({props:{firstPaths:o[12]("title","tagrenderings","editing"),state:o[0]}}),{c(){e=v("div"),t=O(`Information panel (questions and answers)
          `),x(n.$$.fragment),_(e,"slot","title1"),_(e,"class","flex")},m(a,s){b(a,e,s),g(e,t),$(n,e,null),i=!0},p(a,s){const l={};s&1&&(l.state=a[0]),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(e),C(n)}}}function yr(o){let e,t,n,i,a,s,l;return t=new Hn({props:{path:["title"],state:o[0],schema:o[2].title[0]}}),i=new me({props:{configs:o[2].tagrenderings,state:o[0],title:"Popup contents"}}),s=new me({props:{configs:o[2].editing,state:o[0],title:"Other editing elements"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),a=A(),x(s.$$.fragment),_(e,"slot","content1")},m(r,h){b(r,e,h),$(t,e,null),g(e,n),$(i,e,null),g(e,a),$(s,e,null),l=!0},p(r,h){const d={};h&1&&(d.state=r[0]),h&4&&(d.schema=r[2].title[0]),t.$set(d);const p={};h&4&&(p.configs=r[2].tagrenderings),h&1&&(p.state=r[0]),i.$set(p);const c={};h&4&&(c.configs=r[2].editing),h&1&&(c.state=r[0]),s.$set(c)},i(r){l||(u(t.$$.fragment,r),u(i.$$.fragment,r),u(s.$$.fragment,r),l=!0)},o(r){m(t.$$.fragment,r),m(i.$$.fragment,r),m(s.$$.fragment,r),l=!1},d(r){r&&y(e),C(t),C(i),C(s)}}}function wr(o){let e,t,n,i;return n=new Qe({props:{firstPaths:o[12]("presets"),state:o[0]}}),{c(){e=v("div"),t=O(`Creating a new point
          `),x(n.$$.fragment),_(e,"slot","title2")},m(a,s){b(a,e,s),g(e,t),$(n,e,null),i=!0},p(a,s){const l={};s&1&&(l.state=a[0]),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(e),C(n)}}}function vr(o){let e,t,n;return t=new me({props:{state:o[0],configs:o[2].presets}}),{c(){e=v("div"),x(t.$$.fragment),_(e,"slot","content2")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a&1&&(s.state=i[0]),a&4&&(s.configs=i[2].presets),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function _r(o){let e,t,n,i;return n=new Qe({props:{firstPaths:o[12]("linerendering","pointrendering"),state:o[0]}}),{c(){e=v("div"),t=O(`Rendering on the map
          `),x(n.$$.fragment),_(e,"slot","title3"),_(e,"class","flex")},m(a,s){b(a,e,s),g(e,t),$(n,e,null),i=!0},p(a,s){const l={};s&1&&(l.state=a[0]),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(e),C(n)}}}function Tr(o){let e,t,n,i,a;return t=new me({props:{configs:o[2].linerendering,state:o[0]}}),i=new me({props:{configs:o[2].pointrendering,state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),_(e,"slot","content3")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),$(i,e,null),a=!0},p(s,l){const r={};l&4&&(r.configs=s[2].linerendering),l&1&&(r.state=s[0]),t.$set(r);const h={};l&4&&(h.configs=s[2].pointrendering),l&1&&(h.state=s[0]),i.$set(h)},i(s){a||(u(t.$$.fragment,s),u(i.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),m(i.$$.fragment,s),a=!1},d(s){s&&y(e),C(t),C(i)}}}function qr(o){let e,t,n,i;return n=new Qe({props:{firstPaths:o[12]("advanced"),state:o[0]}}),{c(){e=v("div"),t=O(`Advanced functionality
          `),x(n.$$.fragment),_(e,"slot","title4"),_(e,"class","flex")},m(a,s){b(a,e,s),g(e,t),$(n,e,null),i=!0},p(a,s){const l={};s&1&&(l.state=a[0]),n.$set(l)},i(a){i||(u(n.$$.fragment,a),i=!0)},o(a){m(n.$$.fragment,a),i=!1},d(a){a&&y(e),C(n)}}}function kr(o){let e,t,n,i,a;return t=new me({props:{configs:o[2].advanced,state:o[0]}}),i=new me({props:{configs:o[2].expert,state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),_(e,"slot","content4")},m(s,l){b(s,e,l),$(t,e,null),g(e,n),$(i,e,null),a=!0},p(s,l){const r={};l&4&&(r.configs=s[2].advanced),l&1&&(r.state=s[0]),t.$set(r);const h={};l&4&&(h.configs=s[2].expert),l&1&&(h.state=s[0]),i.$set(h)},i(s){a||(u(t.$$.fragment,s),u(i.$$.fragment,s),a=!0)},o(s){m(t.$$.fragment,s),m(i.$$.fragment,s),a=!1},d(s){s&&y(e),C(t),C(i)}}}function xr(o){let e;return{c(){e=v("div"),e.textContent="Configuration file",_(e,"slot","title5")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function $r(o){let e,t,n,i,a,s,l,r,h,d,p,c,f,w;return i=new zn({props:{messages:o[6]}}),r=new Kn({props:{state:o[0]}}),f=new Si({props:{tags:o[0].testTags}}),{c(){e=v("div"),t=v("div"),t.textContent="Below, you'll find the raw configuration file in `.json`-format. This is mostly for\n            debugging purposes, but you can also edit the file directly if you want.",n=A(),x(i.$$.fragment),a=A(),s=v("div"),l=v("div"),x(r.$$.fragment),h=A(),d=v("div"),p=v("div"),p.textContent=`The testobject (which is used to render the questions in the 'information panel'
                item has the following tags:`,c=A(),x(f.$$.fragment),_(l,"class","literal-code h-full w-5/6 overflow-y-auto"),_(d,"class","h-full w-1/6"),_(s,"class","flex h-full w-full flex-row justify-between overflow-y-auto"),_(e,"slot","content5"),_(e,"class","flex h-full flex-col")},m(k,T){b(k,e,T),g(e,t),g(e,n),$(i,e,null),g(e,a),g(e,s),g(s,l),$(r,l,null),g(s,h),g(s,d),g(d,p),g(d,c),$(f,d,null),w=!0},p(k,T){const L={};T&64&&(L.messages=k[6]),i.$set(L);const N={};T&1&&(N.state=k[0]),r.$set(N);const D={};T&1&&(D.tags=k[0].testTags),f.$set(D)},i(k){w||(u(i.$$.fragment,k),u(r.$$.fragment,k),u(f.$$.fragment,k),w=!0)},o(k){m(i.$$.fragment,k),m(r.$$.fragment,k),m(f.$$.fragment,k),w=!1},d(k){k&&y(e),C(i),C(r),C(f)}}}function Tn(o){let e,t;return e=new jn({props:{$$slots:{default:[Cr]},$$scope:{ctx:o}}}),e.$on("close",o[18]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&524417&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Cr(o){let e,t,n;return t=new Gs({props:{path:o[7].path,state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment)},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a&128&&(s.path=i[7].path),a&1&&(s.state=i[0]),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function qn(o){let e,t;return e=new Ve({props:{state:o[0],schema:o[13](o[24]),path:[o[24]]}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&1&&(a.state=n[0]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Ar(o){let e,t,n,i,a,s,l,r,h,d;const p=o[17].default,c=be(p,o,o[19],null);function f(q,I){return q[3]===void 0?hr:lr}let w=f(o),k=w(o);const T=[cr,pr,dr],L=[];function N(q,I){return q[4].length>0?0:q[5]>0?1:2}a=N(o),s=L[a]=T[a](o);const D=[ur,fr],R=[];function S(q,I){return q[4].length>0?0:1}return r=S(o),h=R[r]=D[r](o),{c(){e=v("div"),t=v("div"),c&&c.c(),n=A(),k.c(),i=A(),s.c(),l=A(),h.c(),_(t,"class","my-2 flex w-full justify-between"),_(e,"class","flex h-screen flex-col")},m(q,I){b(q,e,I),g(e,t),c&&c.m(t,null),g(t,n),k.m(t,null),g(t,i),L[a].m(t,null),g(e,l),R[r].m(e,null),d=!0},p(q,[I]){c&&c.p&&(!d||I&524288)&&ye(c,p,q,q[19],d?ve(p,q[19],I,null):we(q[19]),null),w===(w=f(q))&&k?k.p(q,I):(k.d(1),k=w(q),k&&(k.c(),k.m(t,i)));let M=a;a=N(q),a===M?L[a].p(q,I):(G(),m(L[M],1,1,()=>{L[M]=null}),Y(),s=L[a],s?s.p(q,I):(s=L[a]=T[a](q),s.c()),u(s,1),s.m(t,null));let J=r;r=S(q),r===J?R[r].p(q,I):(G(),m(R[J],1,1,()=>{R[J]=null}),Y(),h=R[r],h?h.p(q,I):(h=R[r]=D[r](q),h.c()),u(h,1),h.m(e,null))},i(q){d||(u(c,q),u(s),u(h),d=!0)},o(q){m(c,q),m(s),m(h),d=!1},d(q){q&&y(e),c&&c.d(q),k.d(),L[a].d(),R[r].d()}}}function Rr(o,e,t){let n,i,a,s,l,{$$slots:r={},$$scope:h}=e;const d=Pn;let{state:p}=e,{backToStudio:c}=e,f=p.messages;te(o,f,W=>t(6,s=W));let w=f.mapD(W=>W.filter(j=>j.level==="error").length);te(o,w,W=>t(5,a=W));const k=p.configuration,T=ke.Dedup(d.map(W=>W.hints.group)),L={};for(const W of T)L[W]=d.filter(j=>j.hints.group===W);let N=p.getStoreFor(["id"]);te(o,N,W=>t(3,n=W));const D=window.location,R=D.protocol+"//"+D.host+"/theme.html?userlayout=";function S(...W){const j=new Set;for(const F of W){const V=L[F];for(const B of V)j.add(B.path[0])}return j}function q(W){let j=d.find(F=>F.path.length===1&&F.path[0]===W);return j=ke.Clone(j),j.required=!0,j.hints.ifunset=void 0,j}let I=["id","name","description","source"],M=k.map(W=>{if(!W)return[];const j=[];for(const F of I)W[F]||j.push(F);return j});te(o,M,W=>t(4,i=W));let J=p.highlightedItem;te(o,J,W=>t(7,l=W));const E=()=>J.setData(void 0);return o.$$set=W=>{"state"in W&&t(0,p=W.state),"backToStudio"in W&&t(1,c=W.backToStudio),"$$scope"in W&&t(19,h=W.$$scope)},[p,c,L,n,i,a,s,l,f,w,N,R,S,q,I,M,J,r,E,h]}class Sr extends ae{constructor(e){super(),re(this,e,Rr,Ar,le,{state:0,backToStudio:1})}}class Ir{constructor(e,t){de(this,"url");de(this,"_userId");de(this,"overview");this.url=e,this._userId=t,this.overview=_e.FromPromiseWithErr(this.fetchOverviewRaw())}fetchOverview(){return this.overview}async fetchOverviewRaw(){const{allFiles:e}=await ke.downloadJson(this.url+"/overview"),t=[];for(let n of e){const i=n.split("/");let a=Number(i[0]);isNaN(a)?a=void 0:(i.splice(0,1),n=n.substring(n.indexOf("/")+1));const s=i[0],l=n.substring(n.lastIndexOf("/")+1,n.length-5);Pi.priviliged_layers.indexOf(l)>0||t.push({id:l,owner:a,category:s})}return t}async fetch(e,t,n){try{return await ke.downloadJson(this.urlFor(e,t,n))}catch{return}}async delete(e,t){var i;if(e===void 0||e==="")return;await fetch(this.urlFor(e,t),{method:"DELETE"});const n=(i=this.overview.data)==null?void 0:i.success;if(n){const a=n.findIndex(s=>s.id===e&&s.category===t&&s.owner===this._userId.data);a>=0&&(n.splice(a,1),this.overview.ping())}}async update(e,t,n){e===void 0||e===""||await fetch(this.urlFor(e,n),{method:"POST",headers:{"Content-Type":"application/json;charset=utf-8"},body:t})}layerUrl(e){return this.urlFor(e,"layers")}urlFor(e,t,n){n??(n=this._userId.data);const i=n!==void 0?"/"+n:"";return`${this.url}${i}/${t}/${e}/${e}.json`}}function kn(o,e,t){const n=o.slice();return n[6]=e[t],n}const jr=o=>({}),xn=o=>({});function $n(o){let e,t,n;const i=o[4].title,a=be(i,o,o[3],xn);let s=Array.from(o[0]),l=[];for(let h=0;h<s.length;h+=1)l[h]=Cn(kn(o,s,h));const r=h=>m(l[h],1,1,()=>{l[h]=null});return{c(){a&&a.c(),e=A(),t=v("div");for(let h=0;h<l.length;h+=1)l[h].c();_(t,"class","flex flex-wrap")},m(h,d){a&&a.m(h,d),b(h,e,d),b(h,t,d);for(let p=0;p<l.length;p+=1)l[p]&&l[p].m(t,null);n=!0},p(h,d){if(a&&a.p&&(!n||d&8)&&ye(a,i,h,h[3],n?ve(i,h[3],d,jr):we(h[3]),xn),d&7){s=Array.from(h[0]);let p;for(p=0;p<s.length;p+=1){const c=kn(h,s,p);l[p]?(l[p].p(c,d),u(l[p],1)):(l[p]=Cn(c),l[p].c(),u(l[p],1),l[p].m(t,null))}for(G(),p=s.length;p<l.length;p+=1)r(p);Y()}},i(h){if(!n){u(a,h);for(let d=0;d<s.length;d+=1)u(l[d]);n=!0}},o(h){m(a,h),l=l.filter(Boolean);for(let d=0;d<l.length;d+=1)m(l[d]);n=!1},d(h){a&&a.d(h),h&&y(e),h&&y(t),ue(l,h)}}}function Cn(o){let e,t;return e=new go({props:{info:o[6],category:o[1],osmConnection:o[2]}}),e.$on("layerSelected",o[5]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&1&&(a.info=n[6]),i&2&&(a.category=n[1]),i&4&&(a.osmConnection=n[2]),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Jr(o){let e,t,n=o[0].length>0&&$n(o);return{c(){n&&n.c(),e=ie()},m(i,a){n&&n.m(i,a),b(i,e,a),t=!0},p(i,[a]){i[0].length>0?n?(n.p(i,a),a&1&&u(n,1)):(n=$n(i),n.c(),u(n,1),n.m(e.parentNode,e)):n&&(G(),m(n,1,1,()=>{n=null}),Y())},i(i){t||(u(n),t=!0)},o(i){m(n),t=!1},d(i){n&&n.d(i),i&&y(e)}}}function Wr(o,e,t){let{$$slots:n={},$$scope:i}=e,{layerIds:a}=e,{category:s="layers"}=e,{osmConnection:l}=e;function r(h){he.call(this,o,h)}return o.$$set=h=>{"layerIds"in h&&t(0,a=h.layerIds),"category"in h&&t(1,s=h.category),"osmConnection"in h&&t(2,l=h.osmConnection),"$$scope"in h&&t(3,i=h.$$scope)},[a,s,l,i,n,r]}class Oe extends ae{constructor(e){super(),re(this,e,Wr,Jr,le,{layerIds:0,category:1,osmConnection:2})}}function An(o){let e,t,n=o[2]+1+"",i,a,s;return{c(){e=v("div"),t=v("div"),i=O(n),a=O("/"),s=O(o[3]),_(t,"class","subtle"),_(e,"class","flex justify-end")},m(l,r){b(l,e,r),g(e,t),g(t,i),g(t,a),g(t,s)},p(l,r){r&4&&n!==(n=l[2]+1+"")&&X(i,n),r&8&&X(s,l[3])},d(l){l&&y(e)}}}function Mr(o){let e;return{c(){e=v("div"),_(e,"class","w-full")},m(t,n){b(t,e,n)},p:z,i:z,o:z,d(t){t&&y(e)}}}function Or(o){let e,t;return e=new De({props:{clss:"w-full",$$slots:{default:[Dr]},$$scope:{ctx:o}}}),e.$on("click",o[6]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&256&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Dr(o){let e;return{c(){e=O("Back")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Nr(o){let e;return{c(){e=O("Next")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Fr(o){let e;return{c(){e=O("Finish")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Lr(o){let e;function t(a,s){return a[0]?Fr:Nr}let n=t(o),i=n(o);return{c(){i.c(),e=ie()},m(a,s){i.m(a,s),b(a,e,s)},p(a,s){n!==(n=t(a))&&(i.d(1),i=n(a),i&&(i.c(),i.m(e.parentNode,e)))},d(a){i.d(a),a&&y(e)}}}function Er(o){let e,t,n,i,a,s,l,r,h,d,p;const c=o[5].default,f=be(c,o,o[8],null);let w=o[2]!==void 0&&o[3]!==void 0&&An(o);const k=[Or,Mr],T=[];function L(N,D){return N[1]?1:0}return l=L(o),r=T[l]=k[l](o),d=new qe({props:{clss:"primary w-full",$$slots:{default:[Lr]},$$scope:{ctx:o}}}),d.$on("click",o[7]),{c(){e=v("div"),t=v("div"),f&&f.c(),n=A(),i=v("div"),w&&w.c(),a=A(),s=v("div"),r.c(),h=A(),x(d.$$.fragment),_(t,"class","overflow-y-auto"),_(s,"class","flex w-full"),_(i,"class","flex flex-col"),_(e,"class","link-underline flex h-full w-full flex-col justify-between")},m(N,D){b(N,e,D),g(e,t),f&&f.m(t,null),g(e,n),g(e,i),w&&w.m(i,null),g(i,a),g(i,s),T[l].m(s,null),g(s,h),$(d,s,null),p=!0},p(N,[D]){f&&f.p&&(!p||D&256)&&ye(f,c,N,N[8],p?ve(c,N[8],D,null):we(N[8]),null),N[2]!==void 0&&N[3]!==void 0?w?w.p(N,D):(w=An(N),w.c(),w.m(i,a)):w&&(w.d(1),w=null);let R=l;l=L(N),l===R?T[l].p(N,D):(G(),m(T[R],1,1,()=>{T[R]=null}),Y(),r=T[l],r?r.p(N,D):(r=T[l]=k[l](N),r.c()),u(r,1),r.m(s,h));const S={};D&257&&(S.$$scope={dirty:D,ctx:N}),d.$set(S)},i(N){p||(u(f,N),u(r),u(d.$$.fragment,N),p=!0)},o(N){m(f,N),m(r),m(d.$$.fragment,N),p=!1},d(N){N&&y(e),f&&f.d(N),w&&w.d(),T[l].d(),C(d)}}}function Pr(o,e,t){let{$$slots:n={},$$scope:i}=e;const a=dt();let{islast:s=!1}=e,{isFirst:l=!1}=e,{pageNumber:r=void 0}=e,{totalPages:h=void 0}=e;const d=()=>a("back"),p=()=>a("next");return o.$$set=c=>{"islast"in c&&t(0,s=c.islast),"isFirst"in c&&t(1,l=c.isFirst),"pageNumber"in c&&t(2,r=c.pageNumber),"totalPages"in c&&t(3,h=c.totalPages),"$$scope"in c&&t(8,i=c.$$scope)},[s,l,r,h,a,n,d,p,i]}class Hr extends ae{constructor(e){super(),re(this,e,Pr,Er,le,{islast:0,isFirst:1,pageNumber:2,totalPages:3})}}function Br(o){let e,t;return e=new ze({props:{src:Le(o[0][o[1]])}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i&3&&(a.src=Le(n[0][n[1]])),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Ur(o){let e,t;return e=new Hr({props:{isFirst:o[1]===0,islast:o[1]+1===o[0].length,totalPages:o[0].length,pageNumber:o[1],$$slots:{default:[Br]},$$scope:{ctx:o}}}),e.$on("back",o[3]),e.$on("next",o[4]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,[i]){const a={};i&2&&(a.isFirst=n[1]===0),i&3&&(a.islast=n[1]+1===n[0].length),i&1&&(a.totalPages=n[0].length),i&2&&(a.pageNumber=n[1]),i&67&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function zr(o,e,t){let{pages:n}=e,i=0;const a=dt();function s(h){if(h>0&&i+1===n.length){a("done"),t(1,i=0);return}t(1,i=Math.min(Math.max(0,i+h),n.length))}const l=()=>s(-1),r=()=>s(1);return o.$$set=h=>{"pages"in h&&t(0,n=h.pages)},[n,i,s,l,r]}class Vr extends ae{constructor(e){super(),re(this,e,zr,Ur,le,{pages:0})}}const Xn=[`# Welcome to MapComplete Studio
...
`],Qr={sections:Xn},nt=Object.freeze(Object.defineProperty({__proto__:null,default:Qr,sections:Xn},Symbol.toStringTag,{value:"Module"})),ei=[`# How to work with TagRenderings
...
`],Gr={sections:ei},it=Object.freeze(Object.defineProperty({__proto__:null,default:Gr,sections:ei},Symbol.toStringTag,{value:"Module"}));function Yr(o){let e,t,n,i,a;return n=new ht({props:{class:"h-6 w-6 shrink-0"}}),{c(){e=v("a"),t=O(`Try it out
        `),x(n.$$.fragment),_(e,"class","primary button"),_(e,"href",i=o[9]+o[0].server.urlFor(o[3],"themes")),_(e,"target","_blank"),_(e,"rel","noopener")},m(s,l){b(s,e,l),g(e,t),$(n,e,null),a=!0},p(s,l){(!a||l&9&&i!==(i=s[9]+s[0].server.urlFor(s[3],"themes")))&&_(e,"href",i)},i(s){a||(u(n.$$.fragment,s),a=!0)},o(s){m(n.$$.fragment,s),a=!1},d(s){s&&y(e),C(n)}}}function Kr(o){let e,t,n;return{c(){e=v("div"),t=O(o[4]),n=O(" errors detected"),_(e,"class","alert")},m(i,a){b(i,e,a),g(e,t),g(e,n)},p(i,a){a&16&&X(t,i[4])},i:z,o:z,d(i){i&&y(e)}}}function Zr(o){let e;return{c(){e=v("div"),e.textContent="Basic properties",_(e,"slot","title0")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function Xr(o){let e,t,n,i,a,s,l;return t=new me({props:{configs:o[2].basic,path:[],state:o[0],title:"Basic properties"}}),i=new me({props:{configs:o[2].start_location,path:[],state:o[0],title:"Start location"}}),s=new Zn({props:{state:o[0],backToStudio:o[1],objectType:"theme"}}),{c(){e=v("div"),x(t.$$.fragment),n=A(),x(i.$$.fragment),a=A(),x(s.$$.fragment),_(e,"slot","content0"),_(e,"class","mb-8")},m(r,h){b(r,e,h),$(t,e,null),g(e,n),$(i,e,null),g(e,a),$(s,e,null),l=!0},p(r,h){const d={};h&4&&(d.configs=r[2].basic),h&1&&(d.state=r[0]),t.$set(d);const p={};h&4&&(p.configs=r[2].start_location),h&1&&(p.state=r[0]),i.$set(p);const c={};h&1&&(c.state=r[0]),h&2&&(c.backToStudio=r[1]),s.$set(c)},i(r){l||(u(t.$$.fragment,r),u(i.$$.fragment,r),u(s.$$.fragment,r),l=!0)},o(r){m(t.$$.fragment,r),m(i.$$.fragment,r),m(s.$$.fragment,r),l=!1},d(r){r&&y(e),C(t),C(i),C(s)}}}function el(o){let e;return{c(){e=v("div"),e.textContent="Layers",_(e,"slot","title1")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function tl(o){let e,t,n;return t=new me({props:{configs:o[2].layers,path:[],state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment),_(e,"slot","content1")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a&4&&(s.configs=i[2].layers),a&1&&(s.state=i[0]),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function nl(o){let e;return{c(){e=v("div"),e.textContent="Feature switches",_(e,"slot","title2")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function il(o){let e,t,n;return t=new me({props:{configs:o[2].feature_switches,path:[],state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment),_(e,"slot","content2")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a&4&&(s.configs=i[2].feature_switches),a&1&&(s.state=i[0]),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function ol(o){let e;return{c(){e=v("div"),e.textContent="Advanced options",_(e,"slot","title3")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function sl(o){let e,t,n;return t=new me({props:{configs:o[2].advanced,path:[],state:o[0]}}),{c(){e=v("div"),x(t.$$.fragment),_(e,"slot","content3")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a&4&&(s.configs=i[2].advanced),a&1&&(s.state=i[0]),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function al(o){let e;return{c(){e=v("div"),e.textContent="Configuration file",_(e,"slot","title4")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function rl(o){let e,t,n,i,a,s,l,r;return i=new zn({props:{messages:o[5]}}),l=new Kn({props:{state:o[0]}}),{c(){e=v("div"),t=v("div"),t.textContent="Below, you'll find the raw configuration file in `.json`-format. This is mostly for\n          debugging purposes, but you can also edit the file directly if you want.",n=A(),x(i.$$.fragment),a=A(),s=v("div"),x(l.$$.fragment),_(s,"class","literal-code h-full w-full"),_(e,"slot","content4"),_(e,"class","flex h-full flex-col")},m(h,d){b(h,e,d),g(e,t),g(e,n),$(i,e,null),g(e,a),g(e,s),$(l,s,null),r=!0},p(h,d){const p={};d&32&&(p.messages=h[5]),i.$set(p);const c={};d&1&&(c.state=h[0]),l.$set(c)},i(h){r||(u(i.$$.fragment,h),u(l.$$.fragment,h),r=!0)},o(h){m(i.$$.fragment,h),m(l.$$.fragment,h),r=!1},d(h){h&&y(e),C(i),C(l)}}}function ll(o){let e,t,n,i,a,s,l,r,h,d,p,c,f;const w=o[13].default,k=be(w,o,o[14],null),T=[Kr,Yr],L=[];function N(D,R){return D[4]>0?0:1}return r=N(o),h=L[r]=T[r](o),c=new In({props:{$$slots:{content4:[rl],title4:[al],content3:[sl],title3:[ol],content2:[il],title2:[nl],content1:[tl],title1:[el],content0:[Xr],title0:[Zr]},$$scope:{ctx:o}}}),{c(){e=v("div"),t=v("div"),k&&k.c(),n=A(),i=v("h3"),a=O("Editing theme "),s=O(o[3]),l=A(),h.c(),d=A(),p=v("div"),x(c.$$.fragment),_(t,"class","my-2 flex w-full justify-between"),_(p,"class","m4 h-full overflow-y-auto"),_(e,"class","flex h-screen flex-col")},m(D,R){b(D,e,R),g(e,t),k&&k.m(t,null),g(t,n),g(t,i),g(i,a),g(i,s),g(t,l),L[r].m(t,null),g(e,d),g(e,p),$(c,p,null),f=!0},p(D,[R]){k&&k.p&&(!f||R&16384)&&ye(k,w,D,D[14],f?ve(w,D[14],R,null):we(D[14]),null),(!f||R&8)&&X(s,D[3]);let S=r;r=N(D),r===S?L[r].p(D,R):(G(),m(L[S],1,1,()=>{L[S]=null}),Y(),h=L[r],h?h.p(D,R):(h=L[r]=T[r](D),h.c()),u(h,1),h.m(t,null));const q={};R&16423&&(q.$$scope={dirty:R,ctx:D}),c.$set(q)},i(D){f||(u(k,D),u(h),u(c.$$.fragment,D),f=!0)},o(D){m(k,D),m(h),m(c.$$.fragment,D),f=!1},d(D){D&&y(e),k&&k.d(D),L[r].d(),C(c)}}}function hl(o,e,t){let n,i,a,{$$slots:s={},$$scope:l}=e,{state:r}=e,{osmConnection:h}=e,{backToStudio:d}=e,p=r.schema.filter(R=>R.path.length>0),{selfLayers:c}=e,{otherLayers:f}=e;{const S=p.find(q=>q.path.join(".")==="layers").hints.suggestions;S.unshift(...c.map(q=>({if:`value=https://studio.mapcomplete.org/${q.owner}/layers/${q.id}/${q.id}.json`,then:`<b>${q.id}</b> (made by you)`})));for(let q=0;q<f.length;q++){const I=f[q],M={if:`value=https://studio.mapcomplete.org/${I.owner}/layers/${I.id}/${I.id}.json`,then:`<b>${I.id}</b> (made by ${I.owner})`};h.getInformationAboutUser(I.owner).then(J=>{M.then=`<b>${I.id}</b> (made by ${J.display_name})`}),S.push(M)}}let w=r.messages;te(o,w,R=>t(5,a=R));let k=w.map(R=>R.filter(S=>S.level==="error").length);te(o,k,R=>t(4,i=R));let T=r.getStoreFor(["id"]);te(o,T,R=>t(3,n=R));const L=window.location,N=L.protocol+"//"+L.host+"/theme.html?userlayout=",D={};for(const R of p){if(R.path.length>1&&R.path[0]==="layers")continue;const S=R.hints.group??"no-group";(D[S]??(D[S]=[])).push(R)}return console.log({perRegion:D,schema:p}),o.$$set=R=>{"state"in R&&t(0,r=R.state),"osmConnection"in R&&t(10,h=R.osmConnection),"backToStudio"in R&&t(1,d=R.backToStudio),"selfLayers"in R&&t(11,c=R.selfLayers),"otherLayers"in R&&t(12,f=R.otherLayers),"$$scope"in R&&t(14,l=R.$$scope)},[r,d,D,n,i,a,w,k,T,N,h,c,f,s,l]}class dl extends ae{constructor(e){super(),re(this,e,hl,ll,le,{state:0,osmConnection:10,backToStudio:1,selfLayers:11,otherLayers:12})}}function pl(o){let e,t,n,i=o[16].error+"",a,s,l;return{c(){e=v("div"),t=v("div"),n=O("Something went wrong while contacting the MapComplete Studio Server: "),a=O(i),s=O(`
    ...
    `),l=v("ul"),l.innerHTML=`<li>Try again in a few minutes</li> 
      ...
      <li>Contact the devs via <a href="mailto:info@posteo.net">email</a></li>`,_(t,"class","alert")},m(r,h){b(r,e,h),g(e,t),g(t,n),g(t,a),g(e,s),g(e,l)},p(r,h){h[0]&65536&&i!==(i=r[16].error+"")&&X(a,i)},d(r){r&&y(e)}}}function cl(o){let e,t;return e=new dl({props:{state:o[22],selfLayers:o[9],otherLayers:o[10],osmConnection:o[17],backToStudio:o[41],$$slots:{default:[wl]},$$scope:{ctx:o}}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&512&&(a.selfLayers=n[9]),i[0]&1024&&(a.otherLayers=n[10]),i[0]&4&&(a.backToStudio=n[41]),i[0]&4|i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function fl(o){let e,t;return e=new Sr({props:{state:o[20],backToStudio:o[39],$$slots:{default:[_l]},$$scope:{ctx:o}}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&4&&(a.backToStudio=n[39]),i[0]&4|i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function ul(o){let e,t,n;return t=new zi({}),{c(){e=v("div"),x(t.$$.fragment),_(e,"class","h-8 w-8")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p:z,i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function gl(o){let e,t,n,i,a,s,l,r,h,d,p,c,f,w,k,T,L,N,D,R,S,q,I;return t=new De({props:{clss:"small p-1",imageClass:"w-8 h-8",$$slots:{default:[Tl]},$$scope:{ctx:o}}}),t.$on("click",o[36]),r=new Fn({props:{"aria-hidden":"true",class:"h-8 w-8"}}),c=new Oe({props:{osmConnection:o[17],layerIds:o[12],$$slots:{title:[ql]},$$scope:{ctx:o}}}),c.$on("layerSelected",o[25]),T=new Oe({props:{osmConnection:o[17],layerIds:o[13]}}),T.$on("layerSelected",o[25]),R=new Oe({props:{osmConnection:o[17],layerIds:o[14]}}),R.$on("layerSelected",o[25]),{c(){e=v("div"),x(t.$$.fragment),n=A(),i=v("h2"),i.textContent="Choose a theme to edit",a=A(),s=v("form"),l=v("label"),x(r.$$.fragment),h=A(),d=v("input"),p=A(),x(c.$$.fragment),f=A(),w=v("h3"),w.textContent="Themes by other contributors",k=A(),x(T.$$.fragment),L=A(),N=v("h3"),N.textContent="Official themes by MapComplete",D=A(),x(R.$$.fragment),_(d,"class","mr-4 w-full outline-none"),_(d,"id","theme-search"),_(d,"type","search"),_(d,"placeholder","Filter themes by name"),_(l,"class","neutral-label my-2 flex w-full items-center rounded-full border-2 border-black sm:w-1/2"),_(s,"class","flex justify-center"),_(e,"class","m-4 flex flex-col")},m(M,J){b(M,e,J),$(t,e,null),g(e,n),g(e,i),g(e,a),g(e,s),g(s,l),$(r,l,null),g(l,h),g(l,d),et(d,o[1]),g(e,p),$(c,e,null),g(e,f),g(e,w),g(e,k),$(T,e,null),g(e,L),g(e,N),g(e,D),$(R,e,null),S=!0,q||(I=Z(d,"input",o[37]),q=!0)},p(M,J){const E={};J[1]&4194304&&(E.$$scope={dirty:J,ctx:M}),t.$set(E),J[0]&2&&d.value!==M[1]&&et(d,M[1]);const W={};J[0]&4096&&(W.layerIds=M[12]),J[1]&4194304&&(W.$$scope={dirty:J,ctx:M}),c.$set(W);const j={};J[0]&8192&&(j.layerIds=M[13]),T.$set(j);const F={};J[0]&16384&&(F.layerIds=M[14]),R.$set(F)},i(M){S||(u(t.$$.fragment,M),u(r.$$.fragment,M),u(c.$$.fragment,M),u(T.$$.fragment,M),u(R.$$.fragment,M),S=!0)},o(M){m(t.$$.fragment,M),m(r.$$.fragment,M),m(c.$$.fragment,M),m(T.$$.fragment,M),m(R.$$.fragment,M),S=!1},d(M){M&&y(e),C(t),C(r),C(c),C(T),C(R),q=!1,I()}}}function ml(o){let e,t,n,i,a,s,l,r,h,d,p,c,f,w,k,T,L,N,D,R,S,q,I,M,J,E,W;return t=new De({props:{clss:"small p-1",imageClass:"w-8 h-8",$$slots:{default:[kl]},$$scope:{ctx:o}}}),t.$on("click",o[34]),r=new Fn({props:{"aria-hidden":"true",class:"h-8 w-8"}}),c=new Oe({props:{osmConnection:o[17],layerIds:o[9],$$slots:{title:[xl]},$$scope:{ctx:o}}}),c.$on("layerSelected",o[24]),N=new Oe({props:{osmConnection:o[17],layerIds:o[10]}}),N.$on("layerSelected",o[24]),M=new Oe({props:{osmConnection:o[17],layerIds:o[11]}}),M.$on("layerSelected",o[24]),{c(){e=v("div"),x(t.$$.fragment),n=A(),i=v("h2"),i.textContent="Choose a layer to edit",a=A(),s=v("form"),l=v("label"),x(r.$$.fragment),h=A(),d=v("input"),p=A(),x(c.$$.fragment),f=A(),w=v("h3"),w.textContent="Layers by other contributors",k=A(),T=v("div"),T.textContent=`Selecting a layer will create a copy in your account that you edit. You will not change
          the version of the other contributor`,L=A(),x(N.$$.fragment),D=A(),R=v("h3"),R.textContent="Official layers by MapComplete",S=A(),q=v("div"),q.textContent=`Selecting a layer will create a copy in your account. You will not change the version that
          is in MapComplete`,I=A(),x(M.$$.fragment),_(d,"class","mr-4 w-full outline-none"),_(d,"id","layer-search"),_(d,"type","search"),_(d,"placeholder","Filter layers by name"),_(l,"class","neutral-label my-2 flex w-full items-center rounded-full border-2 border-black sm:w-1/2"),_(s,"class","flex justify-center"),_(e,"class","m-4 flex flex-col")},m(j,F){b(j,e,F),$(t,e,null),g(e,n),g(e,i),g(e,a),g(e,s),g(s,l),$(r,l,null),g(l,h),g(l,d),et(d,o[0]),g(e,p),$(c,e,null),g(e,f),g(e,w),g(e,k),g(e,T),g(e,L),$(N,e,null),g(e,D),g(e,R),g(e,S),g(e,q),g(e,I),$(M,e,null),J=!0,E||(W=Z(d,"input",o[35]),E=!0)},p(j,F){const V={};F[1]&4194304&&(V.$$scope={dirty:F,ctx:j}),t.$set(V),F[0]&1&&d.value!==j[0]&&et(d,j[0]);const B={};F[0]&512&&(B.layerIds=j[9]),F[1]&4194304&&(B.$$scope={dirty:F,ctx:j}),c.$set(B);const H={};F[0]&1024&&(H.layerIds=j[10]),N.$set(H);const ee={};F[0]&2048&&(ee.layerIds=j[11]),M.$set(ee)},i(j){J||(u(t.$$.fragment,j),u(r.$$.fragment,j),u(c.$$.fragment,j),u(N.$$.fragment,j),u(M.$$.fragment,j),J=!0)},o(j){m(t.$$.fragment,j),m(r.$$.fragment,j),m(c.$$.fragment,j),m(N.$$.fragment,j),m(M.$$.fragment,j),J=!1},d(j){j&&y(e),C(t),C(r),C(c),C(N),C(M),E=!1,W()}}}function bl(o){let e,t,n,i,a,s,l,r,h,d,p,c,f,w,k,T,L,N,D,R,S,q,I,M,J,E,W,j;return a=new qe({props:{$$slots:{default:[$l]},$$scope:{ctx:o}}}),a.$on("click",o[29]),l=new qe({props:{$$slots:{default:[Cl]},$$scope:{ctx:o}}}),l.$on("click",o[30]),h=new qe({props:{$$slots:{default:[Al]},$$scope:{ctx:o}}}),h.$on("click",o[31]),p=new qe({props:{$$slots:{default:[Rl]},$$scope:{ctx:o}}}),p.$on("click",o[32]),w=new oo({props:{class:"h-6 w-6"}}),N=new Gi({props:{class:"h-6 w-6"}}),R=new Li({props:{t:Ei.t.general.backToIndex}}),I=new Ui({props:{selected:o[18],$$slots:{default:[Sl]},$$scope:{ctx:o}}}),{c(){e=v("div"),t=v("div"),n=v("h1"),n.textContent="MapComplete Studio",i=A(),x(a.$$.fragment),s=A(),x(l.$$.fragment),r=A(),x(h.$$.fragment),d=A(),x(p.$$.fragment),c=A(),f=v("button"),x(w.$$.fragment),k=O(`
            Show the introduction again`),T=A(),L=v("a"),x(N.$$.fragment),D=A(),x(R.$$.fragment),S=A(),q=v("div"),x(I.$$.fragment),M=A(),J=v("span"),J.textContent=`MapComplete version ${o[23]}`,_(f,"class","small"),_(L,"class","button flex"),_(L,"href",ke.HomepageLink()),_(t,"class","flex w-full flex-col"),_(J,"class","subtle"),_(e,"class","flex h-full flex-col justify-between p-4")},m(F,V){b(F,e,V),g(e,t),g(t,n),g(t,i),$(a,t,null),g(t,s),$(l,t,null),g(t,r),$(h,t,null),g(t,d),$(p,t,null),g(t,c),g(t,f),$(w,f,null),g(f,k),g(t,T),g(t,L),$(N,L,null),g(L,D),$(R,L,null),g(e,S),g(e,q),$(I,q,null),g(q,M),g(q,J),E=!0,W||(j=Z(f,"click",o[33]),W=!0)},p(F,V){const B={};V[1]&4194304&&(B.$$scope={dirty:V,ctx:F}),a.$set(B);const H={};V[1]&4194304&&(H.$$scope={dirty:V,ctx:F}),l.$set(H);const ee={};V[1]&4194304&&(ee.$$scope={dirty:V,ctx:F}),h.$set(ee);const K={};V[1]&4194304&&(K.$$scope={dirty:V,ctx:F}),p.$set(K);const se={};V[1]&4194304&&(se.$$scope={dirty:V,ctx:F}),I.$set(se)},i(F){E||(u(a.$$.fragment,F),u(l.$$.fragment,F),u(h.$$.fragment,F),u(p.$$.fragment,F),u(w.$$.fragment,F),u(N.$$.fragment,F),u(R.$$.fragment,F),u(I.$$.fragment,F),E=!0)},o(F){m(a.$$.fragment,F),m(l.$$.fragment,F),m(h.$$.fragment,F),m(p.$$.fragment,F),m(w.$$.fragment,F),m(N.$$.fragment,F),m(R.$$.fragment,F),m(I.$$.fragment,F),E=!1},d(F){F&&y(e),C(a),C(l),C(h),C(p),C(w),C(N),C(R),C(I),W=!1,j()}}}function yl(o){let e;return{c(){e=O("MapComplete Studio")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function wl(o){let e,t;return e=new De({props:{clss:"small p-1",imageClass:"w-8 h-8",$$slots:{default:[yl]},$$scope:{ctx:o}}}),e.$on("click",o[40]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function vl(o){let e;return{c(){e=O("MapComplete Studio")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function _l(o){let e,t;return e=new De({props:{clss:"small p-1",imageClass:"w-8 h-8",$$slots:{default:[vl]},$$scope:{ctx:o}}}),e.$on("click",o[38]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Tl(o){let e;return{c(){e=O("MapComplete Studio")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function ql(o){let e;return{c(){e=v("h3"),e.textContent="Your themes",_(e,"slot","title")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function kl(o){let e;return{c(){e=O("MapComplete Studio")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function xl(o){let e;return{c(){e=v("h3"),e.textContent="Your layers",_(e,"slot","title")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function $l(o){let e;return{c(){e=v("div"),e.innerHTML=`<div>Edit an existing layer</div> 
              <div class="font-normal">Edit layers you created, others created or from the official MapComplete</div>`,_(e,"class","flex flex-col items-start")},m(t,n){b(t,e,n)},p:z,d(t){t&&y(e)}}}function Cl(o){let e;return{c(){e=O("Create a new layer")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Al(o){let e;return{c(){e=O("Edit a theme")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Rl(o){let e;return{c(){e=O("Create a new theme")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Sl(o){let e;return{c(){e=O("Enable more options (expert mode)")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Rn(o){let e,t;return e=new jn({props:{$$slots:{default:[Il]},$$scope:{ctx:o}}}),e.$on("close",o[43]),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&32768|i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Il(o){var i;let e,t,n;return t=new Vr({props:{pages:(i={intro:nt,tagrenderings:it}[o[15]])==null?void 0:i.sections}}),t.$on("done",o[42]),{c(){e=v("div"),x(t.$$.fragment),_(e,"class","flex h-full p-4 pr-12")},m(a,s){b(a,e,s),$(t,e,null),n=!0},p(a,s){var r;const l={};s[0]&32768&&(l.pages=(r={intro:nt,tagrenderings:it}[a[15]])==null?void 0:r.sections),t.$set(l)},i(a){n||(u(t.$$.fragment,a),n=!0)},o(a){m(t.$$.fragment,a),n=!1},d(a){a&&y(e),C(t)}}}function jl(o){var d;let e,t,n,i,a;const s=[bl,ml,gl,ul,fl,cl],l=[];function r(p,c){return p[2]===void 0?0:p[2]==="edit_layer"?1:p[2]==="edit_theme"?2:p[2]==="loading"?3:p[2]==="editing_layer"?4:p[2]==="editing_theme"?5:-1}~(e=r(o))&&(t=l[e]=s[e](o));let h=((d={intro:nt,tagrenderings:it}[o[15]])==null?void 0:d.sections)&&Rn(o);return{c(){t&&t.c(),n=A(),h&&h.c(),i=ie()},m(p,c){~e&&l[e].m(p,c),b(p,n,c),h&&h.m(p,c),b(p,i,c),a=!0},p(p,c){var w;let f=e;e=r(p),e===f?~e&&l[e].p(p,c):(t&&(G(),m(l[f],1,1,()=>{l[f]=null}),Y()),~e?(t=l[e],t?t.p(p,c):(t=l[e]=s[e](p),t.c()),u(t,1),t.m(n.parentNode,n)):t=null),(w={intro:nt,tagrenderings:it}[p[15]])!=null&&w.sections?h?(h.p(p,c),c[0]&32768&&u(h,1)):(h=Rn(p),h.c(),u(h,1),h.m(i.parentNode,i)):h&&(G(),m(h,1,1,()=>{h=null}),Y())},i(p){a||(u(t),u(h),a=!0)},o(p){m(t),m(h),a=!1},d(p){~e&&l[e].d(p),p&&y(n),h&&h.d(p),p&&y(i)}}}function Jl(o){let e;return{c(){e=O("Please log in to use MapComplete Studio")},m(t,n){b(t,e,n)},d(t){t&&y(e)}}}function Wl(o){let e,t,n;return t=new qe({props:{clss:"primary",$$slots:{default:[Jl]},$$scope:{ctx:o}}}),t.$on("click",o[28]),{c(){e=v("div"),x(t.$$.fragment),_(e,"slot","not-logged-in")},m(i,a){b(i,e,a),$(t,e,null),n=!0},p(i,a){const s={};a[1]&4194304&&(s.$$scope={dirty:a,ctx:i}),t.$set(s)},i(i){n||(u(t.$$.fragment,i),n=!0)},o(i){m(t.$$.fragment,i),n=!1},d(i){i&&y(e),C(t)}}}function Ml(o){let e,t;return e=new Vi({props:{ignoreLoading:!0,slot:"else",state:{osmConnection:o[17]},$$slots:{"not-logged-in":[Wl],default:[jl]},$$scope:{ctx:o}}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&65031|i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Ol(o){let e,t;return e=new Bi({props:{condition:o[19].map(o[44]),$$slots:{else:[Ml],default:[pl]},$$scope:{ctx:o}}}),{c(){x(e.$$.fragment)},m(n,i){$(e,n,i),t=!0},p(n,i){const a={};i[0]&130567|i[1]&4194304&&(a.$$scope={dirty:i,ctx:n}),e.$set(a)},i(n){t||(u(e.$$.fragment,n),t=!0)},o(n){m(e.$$.fragment,n),t=!1},d(n){C(e,n)}}}function Dl(o,e,t){let n,i,a,s,l,r,h,d=z,p=()=>(d(),d=Me(n,Q=>t(9,h=Q)),n),c,f=z,w=()=>(f(),f=Me(i,Q=>t(10,c=Q)),i),k,T=z,L=()=>(T(),T=Me(a,Q=>t(11,k=Q)),a),N,D=z,R=()=>(D(),D=Me(s,Q=>t(12,N=Q)),s),S,q=z,I=()=>(q(),q=Me(l,Q=>t(13,S=Q)),l),M,J=z,E=()=>(J(),J=Me(r,Q=>t(14,M=Q)),r),W,j;o.$$.on_destroy.push(()=>d()),o.$$.on_destroy.push(()=>f()),o.$$.on_destroy.push(()=>T()),o.$$.on_destroy.push(()=>D()),o.$$.on_destroy.push(()=>q()),o.$$.on_destroy.push(()=>J());let{studioUrl:F=window.location.hostname==="127.0.0.2"?"http://127.0.0.1:1235":"https://studio.mapcomplete.org"}=e;const V=Fi.GetQueryParameter("oauth_token",void 0,"Used to complete the login");let B=new Qi({oauth_token:V,checkOnlineRegularly:!0});const H=_e.asBoolean(B.GetPreference("studio-expert-mode","false",{documentation:"Indicates if more options are shown in mapcomplete studio"}));H.addCallbackAndRunD(Q=>console.log("Expert mode is",Q));const ee=B.userDetails.data.name,K=B.userDetails.map(Q=>Q==null?void 0:Q.uid),se=new Ir(F,K);let oe=se.fetchOverview();te(o,oe,Q=>t(16,j=Q));let Se="",P=oe.mapD(Q=>{var ne;return(ne=Q.success)==null?void 0:ne.filter(Ne=>Ne.category==="layers")}),U="",pe=oe.mapD(Q=>{var ne;return(ne=Q.success)==null?void 0:ne.filter(Ne=>Ne.category==="themes")}),ce;const We=Pn;let Te=new En(We,se,B,{expertMode:H}),Ie=Te.showIntro;te(o,Ie,Q=>t(15,W=Q));const fe=Mi;let Re=new qo(fe,se,{expertMode:H});const ti=Hi;async function ni(Q){const ne=Q.detail;t(2,ce="loading"),Te.startSavingUpdates(!1),Te.configuration.setData(await se.fetch(ne.id,"layers",ne.owner)),Te.startSavingUpdates(),t(2,ce="editing_layer")}async function ii(Q){const ne=Q.detail;t(2,ce="loading"),Re.startSavingUpdates(!1);const Ne=await se.fetch(ne.id,"themes",ne.owner);Re.configuration.setData(Ne),Re.startSavingUpdates(),t(2,ce="editing_theme")}async function ut(){t(2,ce="loading");const Q={credits:ee,minzoom:15,pointRendering:[{location:["point","centroid"],marker:[{icon:"circle",color:"white"}]}],tagRenderings:["images"],lineRendering:[{width:1,color:"blue"}]};Te.configuration.setData(Q),Te.startSavingUpdates(),t(2,ce="editing_layer")}const oi=()=>B.AttemptLogin(),si=()=>t(2,ce="edit_layer"),ai=()=>ut(),ri=()=>t(2,ce="edit_theme"),li=()=>{Re.configuration.setData({}),Re.startSavingUpdates(),t(2,ce="editing_theme")},hi=()=>{Ie.setData("intro")},di=()=>{t(2,ce=void 0)};function pi(){Se=this.value,t(0,Se)}const ci=()=>{t(2,ce=void 0)};function fi(){U=this.value,t(1,U)}const ui=()=>{t(2,ce=void 0)},gi=()=>{t(2,ce=void 0)},mi=()=>{t(2,ce=void 0)},bi=()=>{t(2,ce=void 0)},yi=()=>{Ie.setData("no")},wi=()=>{Ie.setData("no")},vi=Q=>(Q==null?void 0:Q.error)!==void 0;return o.$$set=Q=>{"studioUrl"in Q&&t(27,F=Q.studioUrl)},o.$$.update=()=>{o.$$.dirty[0]&1&&p(t(8,n=P.mapD(Q=>Q.filter(ne=>ne.owner===K.data&&ne.id.toLowerCase().includes(Se.toLowerCase())),[K]))),o.$$.dirty[0]&1&&w(t(7,i=P.mapD(Q=>Q.filter(ne=>ne.owner!==void 0&&ne.owner!==K.data&&ne.id.toLowerCase().includes(Se.toLowerCase())),[K]))),o.$$.dirty[0]&1&&L(t(6,a=P.mapD(Q=>Q.filter(ne=>ne.owner===void 0&&ne.id.toLowerCase().includes(Se.toLowerCase())),[K]))),o.$$.dirty[0]&2&&R(t(5,s=pe.mapD(Q=>Q.filter(ne=>ne.owner===K.data&&ne.id.toLowerCase().includes(U.toLowerCase())),[K]))),o.$$.dirty[0]&2&&I(t(4,l=pe.mapD(Q=>Q.filter(ne=>ne.owner!==void 0&&ne.owner!==K.data&&ne.id.toLowerCase().includes(U.toLowerCase())),[K]))),o.$$.dirty[0]&2&&E(t(3,r=pe.mapD(Q=>Q.filter(ne=>ne.owner===void 0&&ne.id.toLowerCase().includes(U.toLowerCase())),[K])))},[Se,U,ce,r,l,s,a,i,n,h,c,k,N,S,M,W,j,B,H,oe,Te,Ie,Re,ti,ni,ii,ut,F,oi,si,ai,ri,li,hi,di,pi,ci,fi,ui,gi,mi,bi,yi,wi,vi]}class Nl extends ae{constructor(e){super(),re(this,e,Dl,Ol,le,{studioUrl:27},null,[-1,-1])}}class Fl{setup(){new $i(Nl,{}).SetClass("h-full").AttachTo("main")}}new Fl().setup();
//# sourceMappingURL=studio-157bf664.js.map
